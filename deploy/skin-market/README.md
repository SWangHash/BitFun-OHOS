...
**Skin market** at `https://market.bitfun.com/skin/`.
...
`https://market.bitfun.com/miniapp/api/v1/me`. Public HTTPS avoids coupling
...
`deploy/miniapp-market/nginx-market.bitfun.com.conf`. It keeps MiniApp at
...
install -m 0644 \
  /srv/bitfun-skin-market/app/deploy/miniapp-market/nginx-market.bitfun.com.conf \
  /etc/nginx/sites-available/market.bitfun.com.conf
nginx -t
systemctl reload nginx
curl -fsS http://127.0.0.1:9720/skin/api/v1/health'
curl -fsS https://market.bitfun.com/skin/api/v1/health
curl -fsS https://market.bitfun.com/skin/ >/dev/null
```
