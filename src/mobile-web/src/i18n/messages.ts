...
export const messages: Record<MobileLanguage, MessageTree> = {
  'en-US': {
    ...
    chat: {
      ...
      modelPrimaryDesc: 'Uses the configured primary model',
      modelFast: 'Fast Model',
      modelFastDesc: 'Uses the configured fast model',
  ...
  'zh-CN': {
    ...
    chat: {
      ...
      modelPrimaryDesc: '使用已配置的主力模型',
      modelFast: 'Fast 模型',
      modelFastDesc: '使用已配置的快速模型',
  ...
  'zh-TW': {
    ...
    chat: {
      ...
      modelSelection: '選擇模型',
      modelPrimary: 'Primary 模型',
      modelPrimaryDesc: '使用已設定的主力模型',
      modelFast: 'Fast 模型',
      modelFastDesc: '使用已設定的快速模型',
