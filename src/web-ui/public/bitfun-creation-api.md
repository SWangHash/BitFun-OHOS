# BitFun Creation UI API v1

This is the running installed client. No source repository, compiler, Node.js,
package install, or client rebuild is required. Use BitFunControl discovery
for existing settings and actions; use these files for persistent custom UI.

## Files and activation

- `bitfun-creation.css`: loaded after the packaged stylesheet.
- `bitfun-creation.js`: browser ES module. Export a default function `activate(ui)`.
...
Control calls share the product owner used by GUI and BitFunControl. Copy IDs
...
[data-bitfun-scene="workbench"][data-bitfun-part="navArea"] { }
[data-bitfun-scene="workbench"][data-bitfun-part="sceneArea"] { }
[data-bitfun-component="app-layout"][data-bitfun-part="root"] { }
[data-bitfun-component="scene-bar"][data-bitfun-part="root"] { }
[data-bitfun-creation-slot="sidebar-footer"] { }
```
