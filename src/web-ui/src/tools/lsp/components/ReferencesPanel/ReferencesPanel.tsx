...
export const ReferencesPanel: React.FC<ReferencesPanelProps> = ({
  ...
  if (references.length === 0) {
    return (
      <div className="references-panel" style={panelStyle} data-bitfun-component="references-panel" data-bitfun-part="root" data-bitfun-state="empty">
        <div data-bitfun-component="references-panel" data-bitfun-part="header" className="references-panel__header">
          <div data-bitfun-component="references-panel" data-bitfun-part="title" className="references-panel__title">
            <FileText size={16} />
            <span>{t('lsp.referencesPanel.emptyTitle')}</span>
          </div>
          <IconButton 
            className="references-panel__close" 
            data-bitfun-component="references-panel"
        ...
        <div data-bitfun-component="references-panel" data-bitfun-part="empty" className="references-panel__empty">
          {symbolName
  ...
  return (
    <div className="references-panel" style={panelStyle} data-bitfun-component="references-panel" data-bitfun-part="root">
      <div data-bitfun-component="references-panel" data-bitfun-part="header" className="references-panel__header">
        <div data-bitfun-component="references-panel" data-bitfun-part="title" className="references-panel__title">
          <FileText size={16} />
          <span>
      ...
      <div data-bitfun-component="references-panel" data-bitfun-part="content" className="references-panel__content">
        {groupedReferences.map((group) => (
          <div data-bitfun-component="references-panel" data-bitfun-part="fileGroup" key={group.filePath} className="references-panel__file-group">
            <div data-bitfun-component="references-panel" data-bitfun-part="fileHeader" className="references-panel__file-header" title={group.filePath}>
              <FileText size={14} />
              <div data-bitfun-component="references-panel" data-bitfun-part="filePath" className="references-panel__file-path">
                {group.filePath.replace(/^file:\/\/\//, '')}
              </div>
              <div data-bitfun-component="references-panel" data-bitfun-part="fileCount" className="references-panel__file-count">
                {group.references.length}
              </div>
            </div>

            <div data-bitfun-component="references-panel" data-bitfun-part="list" className="references-panel__reference-list">
              {group.references.map((ref, index) => (
                ...
                >
                  ...
                  <div data-bitfun-component="references-panel" data-bitfun-part="line" className="references-panel__reference-line">
                    {ref.lineNumber}
                  </div>
                  <div data-bitfun-component="references-panel" data-bitfun-part="preview" className="references-panel__reference-preview">
