...
export const Preview: React.FC<PreviewProps> = ({ value, basePath }) => {
  ...
  return (
    <div className="m-editor-preview" data-bitfun-component="editor-tool" data-bitfun-part="meditorPreview">
      <div className="m-editor-preview-content">
        {frontmatter && (
          <section className="m-editor-preview-frontmatter" data-bitfun-component="editor-tool" data-bitfun-part="meditorFrontmatter">
