...
import { OverflowText, Button, Icon, IconButton, SearchField, Select, ScrollArea } from '@bitfun/ui';
...
export const GitBranchHistoryView: React.FC<GitBranchHistoryViewProps> = ({
  ...
  if (loading) {
    return (
      <div className={`git-branch-history-view git-branch-history-view--loading ${className}`} data-bitfun-component="git-branch-history" data-bitfun-part="root" data-bitfun-state="loading">
        <div data-bitfun-component="git-branch-history" data-bitfun-part="loading" className="git-branch-history-view__loading">
  ...
  if (error) {
    return (
      <div className={`git-branch-history-view git-branch-history-view--error ${className}`} data-bitfun-component="git-branch-history" data-bitfun-part="root" data-bitfun-state="error">
        <div data-bitfun-component="git-branch-history" data-bitfun-part="error" className="git-branch-history-view__error">
  ...
  return (
    <div className={`git-branch-history-view ${className}`} data-bitfun-component="git-branch-history" data-bitfun-part="root">
      <div data-bitfun-component="git-branch-history" data-bitfun-part="header" className="git-branch-history-view__header">
        <div data-bitfun-component="git-branch-history" data-bitfun-part="headerLeft" className="git-branch-history-view__header-left">
          {canCherryPick && (
            <div 
          ...
          <SearchField
            data-bitfun-component="git-branch-history"
        ...
        <div data-bitfun-component="git-branch-history" data-bitfun-part="headerRight" className="git-branch-history-view__header-right">
          {canCherryPick && (
            <Button
              size="sm"
              variant="primary"
      ...
      <ScrollArea data-bitfun-component="git-branch-history" data-bitfun-part="content" className="git-branch-history-view__content">
        {filteredCommits.length === 0 ? (
          <div data-bitfun-component="git-branch-history" data-bitfun-part="empty" className="git-branch-history-view__empty">
            <p>{searchQuery ? t('empty.noMatchingCommits') : t('empty.noCommits')}</p>
          </div>
        ) : (
          <div data-bitfun-component="git-branch-history" data-bitfun-part="commits" className="git-branch-history-view__commits">
            {filteredCommits.map((commit, index) => {
              ...
              return (
                <div 
                  ...
                  data-bitfun-state={[isExpanded && 'expanded', isSelected && 'selected'].filter(Boolean).join(' ') || undefined}
                  key={commit.hash}
                ...
                >
                  ...
                  >
                    ...
                    <div data-bitfun-component="git-branch-history" data-bitfun-part="timeline" className="git-branch-history-view__timeline">
                    ...
                    <div data-bitfun-component="git-branch-history" data-bitfun-part="commitInfo" className="git-branch-history-view__commit-info">
                  ...
                  {isExpanded && (
                    <div data-bitfun-component="git-branch-history" data-bitfun-part="commitDetails" className="git-branch-history-view__commit-details">
