...
import { Button, Icon, IconButton, SearchField, ScrollArea } from '@bitfun/ui';
...
export const GitGraphView: React.FC<GitGraphViewProps> = ({
  ...
  if (loading) {
    return (
      <div className={`git-graph-view git-graph-view--loading ${className}`} data-bitfun-component="git-tool" data-bitfun-part="graphRoot" data-bitfun-state="loading">
        <div className="git-graph-view__loading" data-bitfun-component="git-tool" data-bitfun-part="graphStatus">
  ...
  if (error) {
    return (
      <div className={`git-graph-view git-graph-view--error ${className}`} data-bitfun-component="git-tool" data-bitfun-part="graphRoot" data-bitfun-state="error">
        <div className="git-graph-view__error" data-bitfun-component="git-tool" data-bitfun-part="graphStatus">
  ...
  if (!graphData || graphData.nodes.length === 0) {
    return (
      <div className={`git-graph-view git-graph-view--empty ${className}`} data-bitfun-component="git-tool" data-bitfun-part="graphRoot" data-bitfun-state="empty">
        <div className="git-graph-view__empty" data-bitfun-component="git-tool" data-bitfun-part="graphStatus">
          <p>{t('graph.empty')}</p>
        </div>
      </div>
    );
  ...
  return (
    <div className={`git-graph-view ${className}`} data-bitfun-component="git-tool" data-bitfun-part="graphRoot">
      <div className="git-graph-view__header" data-bitfun-component="git-tool" data-bitfun-part="graphHeader">
      ...
      <ScrollArea 
        ...
        ref={containerRef}
        data-bitfun-component="git-tool"
        data-bitfun-part="graphContent"
      >
...
function drawNodeWithInfo(
  ...
  const resolveLaneColor = (lane: number) => ensureMinimumContrast(
    ...
    resolveCanvasColor('var(--bitfun-color-surface-canvas)'),
  ...
  if (state.isSelected) {
    ctx.strokeStyle = resolveCanvasColor('var(--bitfun-color-content-on-dark)');
    ctx.lineWidth = 2;
    ctx.beginPath();
  ...
  node.refs.forEach((ref) => {
    ...
    const bgColor = ensureMinimumContrast(
      ...
      resolveCanvasColor('var(--bitfun-color-content-on-dark)'),
      GIT_GRAPH_LANE_MIN_CONTRAST
    );
    ...
    if (ref.isCurrent) {
      ctx.save();
      ctx.fillStyle = resolveCanvasColor('var(--bitfun-color-content-on-dark)');
      ctx.beginPath();
  ...
  ctx.fillStyle = resolveCanvasColor('var(--bitfun-color-content-primary)');
  ...
  ctx.fillStyle = resolveCanvasColor('var(--bitfun-color-content-muted)');
  ...
  ctx.fillStyle = resolveCanvasColor('var(--bitfun-color-content-disabled)');
