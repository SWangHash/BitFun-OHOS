...
import { OverflowText, Button, Icon, IconButton, SegmentedControl } from '@bitfun/ui';
...
const GitDiffView: React.FC<GitDiffViewProps> = ({
  ...
  const renderDiffContent = useCallback((diff: string) => {
    ...
    lines.forEach((line, index) => {
      ...
      if (!line.startsWith('diff ') && !line.startsWith('index ') && 
        ...
        lineNumber++;
        diffLines.push(
          <div data-bitfun-component="git-diff-view" data-bitfun-part="diffLine" key={index} className={`bitfun-git-diff-view__diff-line bitfun-git-diff-view__diff-line--${lineType}`}>
            <span data-bitfun-component="git-diff-view" data-bitfun-part="lineNumber" className="bitfun-git-diff-view__line-number">{lineNumber}</span>
            <span data-bitfun-component="git-diff-view" data-bitfun-part="lineContent" className="bitfun-git-diff-view__line-content">{content}</span>
          </div>
        );
      }
    });
  ...
  if (loading) {
    return (
      <div className={`bitfun-git-diff-view ${className}`} data-bitfun-component="git-diff-view" data-bitfun-part="root" data-bitfun-state="loading">
        <div data-bitfun-component="git-diff-view" data-bitfun-part="loading" className="bitfun-git-diff-view__loading-state">
  ...
  if (error) {
    return (
      <div className={`bitfun-git-diff-view ${className}`} data-bitfun-component="git-diff-view" data-bitfun-part="root" data-bitfun-state="error">
        <div data-bitfun-component="git-diff-view" data-bitfun-part="error" className="bitfun-git-diff-view__error-state">
          <FileText size={48} />
  ...
  return (
    <div className={`bitfun-git-diff-view ${className}`} data-bitfun-component="git-diff-view" data-bitfun-part="root">
      <div className="bitfun-git-diff-view__header" data-bitfun-component="git-diff-view" data-bitfun-part="header">
        <div data-bitfun-component="git-diff-view" data-bitfun-part="headerLeft" className="bitfun-git-diff-view__header-left">
        ...
        <div data-bitfun-component="git-diff-view" data-bitfun-part="headerRight" className="bitfun-git-diff-view__header-right">
      ...
      <div className="bitfun-git-diff-view__content" data-bitfun-component="git-diff-view" data-bitfun-part="content">
        {error ? (
          <div data-bitfun-component="git-diff-view" data-bitfun-part="error" data-bitfun-state="error" className="bitfun-git-diff-view__error-state">
          ...
          <div data-bitfun-component="git-diff-view" data-bitfun-part="loading" data-bitfun-state="loading" className="bitfun-git-diff-view__loading-state">
            <div className="bitfun-git-diff-view__loading-spinner" />
            <p>{t('diffView.loadingData')}</p>
          </div>
        ) : diffFiles.length > 0 ? (
          <div data-bitfun-component="git-diff-view" data-bitfun-part="fileList" className="bitfun-git-diff-view__file-list">
            {diffFiles.map((file, index) => (
              <div data-bitfun-component="git-diff-view" data-bitfun-part="file" data-bitfun-state={file.expanded ? 'expanded' : undefined} key={file.path} className="bitfun-git-diff-view__file-item">
                <div data-overflow-trigger
                  data-bitfun-component="git-diff-view"
                  data-bitfun-part="fileHeader"
                  className="bitfun-git-diff-view__file-header"
                  onClick={() => toggleFileExpansion(index)}
                >
                  <div data-bitfun-component="git-diff-view" data-bitfun-part="fileInfo" className="bitfun-git-diff-view__file-info">
                    ...
                    <OverflowText className="bitfun-git-diff-view__file-path">{file.path}</OverflowText>
                  ...
                  <div data-bitfun-component="git-diff-view" data-bitfun-part="fileStats" className="bitfun-git-diff-view__file-stats">
                    {file.additions > 0 && (
                ...
                {file.expanded && (
                  <div data-bitfun-component="git-diff-view" data-bitfun-part="diffContent" className="bitfun-git-diff-view__diff-content">
          ...
          <div data-bitfun-component="git-diff-view" data-bitfun-part="empty" className="bitfun-git-diff-view__empty-state">
            <FileText size={48} />
