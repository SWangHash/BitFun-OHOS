...
describe('BitFun Canvas structural adapters', () => {
  it('composes cards through the design-system anatomy', () => {
    ...
    expect(markup).toContain('data-bf-component="card"');
    expect(markup).toContain('data-appearance="raised"');
    expect(markup).toContain('data-bf-part="header"');
    expect(markup).toContain('data-bf-part="body"');
  });
  ...
  it('maps pills and empty states to stable feedback primitives', () => {
    ...
    expect(markup).toContain('data-bf-component="status-pill"');
    expect(markup).toContain('data-tone="warning"');
    expect(markup).toContain('data-bf-component="empty"');
  ...
  it('connects tab selection with the matching panel', () => {
    ...
    expect(markup).toContain('data-bf-component="tab-group"');
