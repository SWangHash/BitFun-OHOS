...
export const categoryPaletteLight: Record<CanvasColor, string> = {
  gray: 'var(--bitfun-color-content-muted)',
  purple: 'var(--bitfun-color-accent-default)',
  green: 'var(--bitfun-color-status-success-content)',
  yellow: 'var(--bitfun-color-status-warning-content)',
  cyan: 'var(--bitfun-color-status-info-content)',
  pink: 'var(--bitfun-canvas-danger)',
  blue: 'var(--bitfun-color-accent-default)',
  orange: 'var(--bitfun-color-status-warning-content)',
};

export const categoryPaletteDark = categoryPaletteLight;

export const canvasTokensLight = {
  bg: 'var(--bitfun-color-surface-canvas)',
  panel: 'var(--bitfun-color-surface-panel)',
  elevated: 'var(--bitfun-color-surface-raised)',
  chrome: 'var(--bitfun-color-surface-chrome)',
  text: 'var(--bitfun-color-content-primary)',
  textSecondary: 'var(--bitfun-color-content-secondary)',
  textMuted: 'var(--bitfun-color-content-muted)',
  border: 'var(--bitfun-color-border-subtle)',
  accent: 'var(--bitfun-color-accent-default)',
  success: 'var(--bitfun-color-status-success-content)',
  warning: 'var(--bitfun-color-status-warning-content)',
  danger: 'var(--bitfun-color-status-danger-content)',
...
export function sizeValue(size: unknown): string {
  ...
  return size === 'small' || size === 'sm'
    ? 'var(--bitfun-type-body-xs-font-size)'
    : size === 'lg'
      ? 'var(--bitfun-type-body-lg-font-size)'
      : size === 'body' || size === 'md' || !size
        ? 'var(--bitfun-type-body-sm-font-size)'
        : String(size);
}

export function weightValue(weight: unknown): number | string {
  return weight === 'medium'
    ? 'var(--bitfun-font-weight-medium)'
    : weight === 'semibold'
      ? 'var(--bitfun-font-weight-semibold)'
      : weight === 'bold'
        ? 'var(--bitfun-font-weight-bold)'
        : (weight as number | string | undefined) || 'var(--bitfun-font-weight-regular)';
}
...
export function toneColor(tone: CanvasTone | undefined): string {
  ...
  return 'var(--bitfun-color-content-primary)';
}
