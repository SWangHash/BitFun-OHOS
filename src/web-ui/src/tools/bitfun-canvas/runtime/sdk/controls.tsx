...
export function Toggle({
  ...
  return (
    <label className="bitfun-canvas-toggle">
      {control}
      <span className="bitfun-canvas-toggle__copy">
        {label ? <span className="bitfun-canvas-toggle__label">{label}</span> : null}
        {description ? (
          <span className="bitfun-canvas-toggle__description">{description}</span>
        ) : null}
        {statusText ? <span className="bitfun-canvas-toggle__status">{statusText}</span> : null}
      </span>
    </label>
  );
}
...
export function Select({
  ...
  const selectClassName = ['bitfun-select', className].filter(Boolean).join(' ');
