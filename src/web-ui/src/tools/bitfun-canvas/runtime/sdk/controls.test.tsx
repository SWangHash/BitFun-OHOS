...
describe('BitFun Canvas control adapters', () => {
  it('renders toggle and checkbox through the design system', () => {
    ...
    expect(markup).toContain('data-bitfun-component="switch"');
    expect(markup).toContain('data-bitfun-component="checkbox"');
  ...
  it('renders a sandbox-native select without host i18n requirements', () => {
    ...
    expect(markup).toContain('data-bitfun-component="select"');
  ...
  it('renders text inputs and icon button adapters', () => {
    ...
    expect(markup).toContain('data-bitfun-component="input"');
    expect(markup).toContain('data-bitfun-component="textarea"');
    expect(markup).toContain('data-bitfun-component="icon-button"');
