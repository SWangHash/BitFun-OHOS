...
export const BitFunCanvasPanel: React.FC<BitFunCanvasPanelProps> = ({
  ...
  if (!hasHtml) {
    return (
      <div className="bitfun-canvas-panel bitfun-canvas-panel--empty" data-bitfun-component="canvas-tool" data-bitfun-part="empty" data-bitfun-state="empty">
        <div className="bitfun-canvas-panel__message" data-bitfun-component="canvas-tool" data-bitfun-part="message">
        ...
        {resolvedDiagnostics.length > 0 && (
          <ul className="bitfun-canvas-panel__diagnostics" data-bitfun-component="canvas-tool" data-bitfun-part="diagnostics">
        ...
        {sourcePreview && <pre className="bitfun-canvas-panel__source" data-bitfun-component="canvas-tool" data-bitfun-part="source">{sourcePreview}</pre>}
      </div>
    );
  }

  return (
    <div className="bitfun-canvas-panel" data-bitfun-component="canvas-tool" data-bitfun-part="root">
      <div className="bitfun-canvas-panel__toolbar" data-bitfun-component="canvas-tool" data-bitfun-part="toolbar">
        <IconButton
          type="button"
        ...
        <IconButton
          ...
          icon={exportingHtml ? <Loader2 size={15} className="bitfun-canvas-panel__toolbar-icon--spin" /> : <Icon name="arrow-down" size="sm" />}
        />
      </div>
      {isFrameReady && (
        <iframe
          ...
          data-bitfun-component="canvas-tool"
      ...
      {sourceVisible && (
        <div className="bitfun-canvas-panel__source-overlay" role="dialog" aria-modal="true" data-bitfun-component="canvas-tool" data-bitfun-part="sourceOverlay">
          <div className="bitfun-canvas-panel__source-dialog" data-bitfun-component="canvas-tool" data-bitfun-part="sourceDialog">
