...
const GITCODE_ISSUES_URL = 'https://gitcode.com/BitFun/bitfun_ade/issues';
  ...
  return (
    <>
      ...
      >
        ...
        <div className="bitfun-feedback__root" data-bitfun-component="feedback-dialog" data-bitfun-part="root">
        {completed ? (
          ...
          <div ref={containerRef} className="bitfun-feedback__center">
            <div className="bitfun-feedback__view-switch" role="tablist" data-bitfun-component="feedback-dialog" data-bitfun-part="viewSwitch">
              <button
                type="button"
                role="tab"
            ...
            {activeView === 'create' ? (
              <form className="bitfun-feedback__form" onSubmit={handleSubmit} data-bitfun-component="feedback-dialog" data-bitfun-part="form">
