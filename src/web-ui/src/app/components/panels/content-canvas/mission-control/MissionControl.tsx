...
export const MissionControl: React.FC<MissionControlProps> = ({
  ...
  return (
    <div data-bitfun-component="mission-control" data-bitfun-part="root" data-bitfun-state="open"
      ref={rootRef}
    ...
    >
      <div className="canvas-mission-control__content" data-bitfun-component="mission-control" data-bitfun-part="content">
        {/* Header */}
        <div data-bitfun-component="mission-control" data-bitfun-part="header" className="canvas-mission-control__header">
          <h2 className="canvas-mission-control__title">{t('tabs.missionControl')}</h2>
          <div data-bitfun-component="mission-control" data-bitfun-part="headerActions" className="canvas-mission-control__header-actions">
            {hasMultipleGroups && (
              <Button
                variant="outline"
                size="sm"
        ...
        <div data-bitfun-component="mission-control" data-bitfun-part="filters" className="canvas-mission-control__filters">
          <div className="canvas-mission-control__filters-row">
            <div data-bitfun-component="mission-control" data-bitfun-part="search" className="canvas-mission-control__search-wrapper">
              <SearchFilter
                value={searchQuery}
            ...
            {hasMultipleGroups && (
              <div data-bitfun-component="mission-control" data-bitfun-part="groupFilters" className="canvas-mission-control__group-filters">
                {[
                  ...
                  return (
                    <button data-bitfun-component="mission-control" data-bitfun-part="filter" data-bitfun-group={id} data-bitfun-state={selectedGroups.has(id) ? 'active' : ''}
                      key={id}
        ...
        <ScrollArea data-bitfun-component="mission-control" data-bitfun-part="grid" className="canvas-mission-control__grid">
          {filteredTabs.length > 0 ? (
            ...
            <div data-bitfun-component="mission-control" data-bitfun-part="empty" className="canvas-mission-control__empty">
        ...
        {/* Footer hint */}
        <div data-bitfun-component="mission-control" data-bitfun-part="footer" className="canvas-mission-control__footer">
          <span>{t('canvas.clickToSwitch')}</span>
          <div data-bitfun-component="mission-control" data-bitfun-part="separator" className="canvas-mission-control__separator" />
