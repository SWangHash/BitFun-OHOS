...
const DateTimePickerPopover: React.FC<DateTimePickerPopoverProps> = ({
  ...
  return createPortal(
    <div
      ...
      data-bitfun-component="datetime-picker"
    ...
    >
      <header className="bitfun-datetime-picker__head" data-bitfun-component="datetime-picker" data-bitfun-part="head">
        <IconButton
          type="button"
          size="sm"
        ...
        />
        <span className="bitfun-datetime-picker__month">
      ...
      <div className="bitfun-datetime-picker__weekdays" aria-hidden="true">
        {weekdayLabels.map((label, index) => (
          <span key={index} className="bitfun-datetime-picker__weekday">{label}</span>
        ))}
      </div>

      <div className="bitfun-datetime-picker__grid" role="grid" data-bitfun-component="datetime-picker" data-bitfun-part="grid">
        {grid.map(day => {
          ...
          return (
            <button
              ...
              role="gridcell"
              className={[
                'bitfun-datetime-picker__day',
                isCurrentMonth ? '' : 'bitfun-datetime-picker__day--outside',
                isToday ? 'bitfun-datetime-picker__day--today' : '',
                isSelected ? 'bitfun-datetime-picker__day--selected' : '',
              ].filter(Boolean).join(' ')}
              data-bitfun-component="datetime-picker"
              data-bitfun-part="day"
              data-bitfun-state={isSelected ? 'selected' : isToday ? 'today' : undefined}
      ...
      <footer className="bitfun-datetime-picker__foot" data-bitfun-component="datetime-picker" data-bitfun-part="foot">
