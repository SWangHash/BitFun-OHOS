    ...
    return (
      <>
        ...
        <div
          ...
          data-bitfun-component="app-layout"
          data-bitfun-part="root"
          data-bitfun-state="toolbar"
          data-bitfun-background-media={backgroundMedia?.url ? 'video' : undefined}
        >
      ...
      >
        ...
        {windowModeHint && (
          <div
            ...
            data-bitfun-component="app-layout"
            data-bitfun-part="windowModeHint"
            role="status"
            aria-live="polite"
          >
            <span className="bitfun-window-mode-hint__title" data-bitfun-component="app-layout" data-bitfun-part="windowModeTitle">{windowModeHint.title}</span>
            <OverflowText className="bitfun-window-mode-hint__detail" data-bitfun-component="app-layout" data-bitfun-part="windowModeDetail">{windowModeHint.detail}</OverflowText>
          </div>
        )}

        {/* Main content — always render WorkspaceBody; WelcomeScene in viewport handles no-workspace state */}
        <main className="bitfun-app-main-workspace" data-testid="app-main-content" data-bitfun-component="app-layout" data-bitfun-part="main">
          <WorkspaceBody
