...
import { OverflowText, Button, Icon, IconButton, SearchField, Tooltip, ScrollArea } from '@bitfun/ui';
...
const BranchesView: React.FC<BranchesViewProps> = ({ workspacePath }) => {
  ...
  if (!workspacePath) {
    return (
      <div data-bitfun-component="branches-view" data-bitfun-part="root" className="bitfun-git-scene-branches">
        <div data-bitfun-component="branches-view" data-bitfun-part="placeholder" className="bitfun-git-scene-branches__placeholder">
  ...
  return (
    <div data-bitfun-component="branches-view" data-bitfun-part="root" className="bitfun-git-scene-branches">
      <div data-bitfun-component="branches-view" data-bitfun-part="left" className="bitfun-git-scene-branches__left">
        <div data-bitfun-component="branches-view" data-bitfun-part="toolbar" className="bitfun-git-scene-branches__toolbar">
          <div data-bitfun-component="branches-view" data-bitfun-part="search" className="bitfun-git-scene-branches__toolbar-search">
            <SearchField
              size="sm"
          ...
          <div data-bitfun-component="branches-view" data-bitfun-part="actions" className="bitfun-git-scene-branches__toolbar-actions">
            <Button
              size="sm"
              variant="primary"
        ...
        <ScrollArea data-bitfun-component="branches-view" data-bitfun-part="list" className="bitfun-git-scene-branches__list">
          {branchLoading ? (
            <div data-bitfun-component="branches-view" data-bitfun-part="empty" className="bitfun-git-scene-branches__empty">{t('common.loading')}</div>
          ) : filteredBranches.length === 0 ? (
            <div data-bitfun-component="branches-view" data-bitfun-part="empty" className="bitfun-git-scene-branches__empty">
              {branchSearchQuery ? t('empty.noMatchingBranches') : t('empty.noBranches')}
            </div>
          ) : (
            filteredBranches.map((branch, idx) => (
              <div data-overflow-trigger
                data-bitfun-component="branches-view"
              ...
              >
                <div data-bitfun-component="branches-view" data-bitfun-part="branchInfo" className="bitfun-git-scene-branches__info">
                  <Icon name="git" size="sm" />
                  <OverflowText className="bitfun-git-scene-branches__name">{branch.name}</OverflowText>
                  {branch.current && <span className="bitfun-git-scene-branches__current-badge">{t('branch.current')}</span>}
                </div>
                <div data-bitfun-component="branches-view" data-bitfun-part="branchActions" className="bitfun-git-scene-branches__actions" onClick={e => e.stopPropagation()}>
                  {!branch.current && (
      ...
      <div data-bitfun-component="branches-view" data-bitfun-part="right" className="bitfun-git-scene-branches__right">
        <div data-bitfun-component="branches-view" data-bitfun-part="historyToolbar" className="bitfun-git-scene-branches__history-toolbar">
          <span data-bitfun-component="branches-view" data-bitfun-part="historyTitle" className="bitfun-git-scene-branches__history-title">
        ...
        <ScrollArea data-bitfun-component="branches-view" data-bitfun-part="historyList" className="bitfun-git-scene-branches__history-list">
          {!selectedBranchName ? (
            <div data-bitfun-component="branches-view" data-bitfun-part="empty" className="bitfun-git-scene-branches__empty">{t('empty.noCommits')}</div>
          ) : commitLoading ? (
            <div data-bitfun-component="branches-view" data-bitfun-part="empty" className="bitfun-git-scene-branches__empty">{t('common.loading')}</div>
            ...
            filteredCommits.map((commit, idx) => {
              ...
              return (
                <div data-bitfun-component="branches-view" data-bitfun-part="commit" data-bitfun-state={isExpanded ? 'expanded' : undefined}
                  key={commit.hash ?? idx}
                  className={`bitfun-git-scene-branches__commit ${isExpanded ? 'bitfun-git-scene-branches__commit--expanded' : ''}`}
                >
                  <div data-overflow-trigger data-bitfun-component="branches-view" data-bitfun-part="commitHeader" className="bitfun-git-scene-branches__commit-header" onClick={() => toggleCommitExpand(commit.hash)}>
                    ...
                    <div data-bitfun-component="branches-view" data-bitfun-part="commitInfo" className="bitfun-git-scene-branches__commit-info">
                      <div className="bitfun-git-scene-branches__commit-message"><OverflowText>{summary}</OverflowText></div>
                      <div className="bitfun-git-scene-branches__commit-meta">
                        {author} · {commit.hash?.substring(0, 7)}
                      </div>
                    </div>
                    <div data-bitfun-component="branches-view" data-bitfun-part="commitActions" className="bitfun-git-scene-branches__commit-actions" onClick={e => e.stopPropagation()}>
                  ...
                  {isExpanded && (
                    <div data-bitfun-component="branches-view" data-bitfun-part="commitDetails" className="bitfun-git-scene-branches__commit-detail">
