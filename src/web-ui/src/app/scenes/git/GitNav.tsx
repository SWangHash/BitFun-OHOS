...
const GitNav: React.FC = () => {
  ...
  return (
    <NavigationPanel
      data-bitfun-component="git-nav"
      data-bitfun-part="root"
      className="bitfun-git-scene-nav"
    >
      <NavigationPanelHeader className="bitfun-git-nav__panel-header">
        <div className="bitfun-git-scene-nav__header" data-bitfun-component="git-nav" data-bitfun-part="header">
          <OverflowText className="bitfun-git-scene-nav__title" data-bitfun-component="git-nav" data-bitfun-part="title">{t('title')}</OverflowText>
        </div>
      </NavigationPanelHeader>
      <NavigationPanelBody>
        <NavigationPanelContent className="bitfun-git-nav__panel-content">
          {isRepository && (
            <div className="bitfun-git-scene-nav__status" data-bitfun-component="git-nav" data-bitfun-part="status">
          <div className="bitfun-git-scene-nav__branch-row">
            <Icon name="git" size="xs" aria-hidden />
            <OverflowText className="bitfun-git-scene-nav__branch-name" title={currentBranch ?? undefined}>
        ...
        <div className="bitfun-git-scene-nav__actions-row" data-bitfun-component="git-nav" data-bitfun-part="actions">
