...
const GitScene: React.FC<GitSceneProps> = ({
  ...
  if (!repoLoading && repositoryTrustRequired) {
    return (
      <div className="bitfun-git-scene bitfun-git-scene--not-repository" data-bitfun-scene="git" data-bitfun-part="root" data-bitfun-view="trust-required">
        <div className="bitfun-git-scene__content" data-bitfun-scene="git" data-bitfun-part="content">
          <div className="bitfun-git-scene__init-container" data-bitfun-scene="git" data-bitfun-part="empty">
  ...
  if (!repoLoading && !isRepository) {
    return (
      <div className="bitfun-git-scene bitfun-git-scene--not-repository" data-bitfun-scene="git" data-bitfun-part="root" data-bitfun-view="not-repository">
        <div className="bitfun-git-scene__content" data-bitfun-scene="git" data-bitfun-part="content">
          <div className="bitfun-git-scene__init-container" data-bitfun-scene="git" data-bitfun-part="empty">
  ...
  if ((repoLoading || statusLoading) && !forceReset) {
    return (
      <div className="bitfun-git-scene bitfun-git-scene--loading" data-bitfun-scene="git" data-bitfun-part="root" data-bitfun-view="loading">
        <div className="bitfun-git-scene__content" data-bitfun-scene="git" data-bitfun-part="content">
          ...
          <div className="bitfun-git-scene__loading-state" data-bitfun-scene="git" data-bitfun-part="loading">
  ...
  return (
    <div
      ...
      data-bitfun-scene="git"
      data-bitfun-part="root"
      data-bitfun-view="repository"
    >
      {renderView()}
    </div>
  );
