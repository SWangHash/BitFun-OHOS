...
export const CAPABILITY_ACCENT: Record<CapabilityCategory, string> = {
  coding: 'var(--bitfun-color-accent-default)',
  docs: APPEARANCE_DOMAIN_TOKENS.agentCapability.docs,
  analysis: 'var(--bitfun-color-accent-secondary)',
...
export const CORE_AGENT_ACCENTS = {
  Standard: {
    accentColor: 'var(--bitfun-color-accent-default)',
    accentBg: getAlphaColor('var(--bitfun-color-accent-default)', '1a', 10),
  },
  Cowork: {
  ...
  ComputerUse: {
    accentColor: 'var(--bitfun-color-status-warning-content)',
    accentBg: 'var(--bitfun-color-status-warning-surface)',
  },
