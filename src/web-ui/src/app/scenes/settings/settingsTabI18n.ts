...
export const SETTINGS_TAB_I18N_NAMESPACES: Record<ConfigTab, readonly I18nNamespace[]> = {
  basics: ['settings/application'],
  appearance: ['settings/appearance', 'settings/application'],
  models: ['settings/models', 'settings/default-model', 'components'],
  'usage-statistics': ['settings/usage'],
  ...
  'external-sources': ['settings/external-apps', 'settings/hooks', 'shared'],
  hooks: ['settings/external-apps', 'settings/hooks', 'shared'],
