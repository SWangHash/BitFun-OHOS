...
const ShellNav: React.FC = () => {
  ...
  return (
    <NavigationPanel data-bitfun-component="shell-nav" data-bitfun-part="root" className="bitfun-shell-nav" data-testid="shell-panel">
      <NavigationPanelHeader className="bitfun-shell-nav__panel-header">
        <div data-bitfun-component="shell-nav" data-bitfun-part="header" className="bitfun-shell-nav__header">
        <div className="bitfun-shell-nav__title-group">
          <span data-bitfun-component="shell-nav" data-bitfun-part="title" className="bitfun-shell-nav__title" data-testid="shell-panel-title">{t('nav.shell.title')}</span>
        ...
        <div data-bitfun-component="shell-nav" data-bitfun-part="headerActions" className="bitfun-shell-nav__header-actions" ref={menuRef}>
          <div data-bitfun-component="shell-nav" data-bitfun-part="splitButton" data-bitfun-state={menuOpen ? 'active' : undefined} className={`bitfun-shell-nav__split-button${menuOpen ? ' is-active' : ''}`}>
          ...
          {menuOpen ? createOverlayPortal(
            <Menu
              ref={menuPopoverRef}
              data-bitfun-component="shell-nav"
              data-bitfun-part="menu"
              data-bitfun-placement={createMenuLayout?.placement ?? 'bottom'}
            ...
            >
              ...
              <MenuItem type="button" data-bitfun-component="shell-nav" data-bitfun-part="menuItem" leading={<Icon name="refresh" size="sm" />} onClick={() => { setMenuOpen(false); void handleRefresh(); }}>
      ...
      <NavigationPanelBody className={`bitfun-shell-nav__sections${!hasVisibleContent ? ' bitfun-shell-nav__sections--empty' : ''}`}>
        ...
        {hasVisibleContent ? (
          <div data-bitfun-component="shell-nav" data-bitfun-part="list" className="bitfun-shell-nav__terminal-list" data-testid="shell-command-list">
            {entries.map((entry) => (
              <ShellNavEntryItem
                key={entry.sessionId}
                entry={entry}
          ...
          <div data-bitfun-component="shell-nav" data-bitfun-part="empty" className="bitfun-shell-nav__empty">
