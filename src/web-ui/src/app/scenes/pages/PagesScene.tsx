import { OverflowText, Button, Icon, Input, Select, type SelectOption } from '@bitfun/ui';
...
const PagesScene: React.FC<PagesSceneProps> = ({ isActive = true }) => {
  ...
  return (
    <GalleryLayout className="pages-scene" data-testid="pages-scene" data-bitfun-scene="pages" data-bitfun-part="root">
      <GalleryPageHeader
        data-bitfun-scene="pages"
      ...
      <div className="pages-scene__content" data-bitfun-scene="pages" data-bitfun-part="content">
        {loadError && pages.length > 0 && (
          <div className="pages-scene__refresh-error" role="alert" data-testid="pages-refresh-error" data-bitfun-scene="pages" data-bitfun-part="error">
        ...
        {loading && pages.length === 0 ? (
          ...
          <div className="pages-scene__grid" role="list" data-bitfun-scene="pages" data-bitfun-part="list">
            {pages.map((page) => {
