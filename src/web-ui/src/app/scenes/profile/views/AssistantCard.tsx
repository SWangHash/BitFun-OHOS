...
const AssistantCard: React.FC<AssistantCardProps> = ({
  ...
  return (
    <article
      ...
      data-bf-part="root"
      data-testid={`assistant-card-${workspace.id}`}
    ...
    >
      <button
        ...
        data-testid={`assistant-card-${workspace.id}-main`}
        onClick={onClick}
      ...
      <footer className="assistant-card__footer" data-bf-component="assistant-card" data-bf-part="footer">
        {onNewSession ? (
          <button
            ...
            data-testid={`assistant-card-${workspace.id}-new-session-btn`}
            type="button"
          ...
          {onSetPrimary ? (
            <Tooltip content={t('nursery.card.setPrimary')} placement="top">
              <button
                ...
                data-testid={`assistant-card-${workspace.id}-set-primary-btn`}
          ...
          {onDelete ? (
            <Tooltip content={t('nursery.card.delete')} placement="top">
              <button
                ...
                data-testid={`assistant-card-${workspace.id}-delete-btn`}
                onClick={onDelete}
