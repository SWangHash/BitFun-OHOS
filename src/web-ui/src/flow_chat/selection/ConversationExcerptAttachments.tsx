...
import { createOverlayPortal, Button, Card, Icon, IconButton, useDismissibleLayer } from '@bitfun/ui';
...
export function ConversationExcerptAttachments({ contexts, onUpdate, onRemove, inline = false }: {
  ...
  return <div data-bitfun-product-component="conversation-excerpt" data-bitfun-product-part="attachments"
    ...
    <div ref={anchorRef} className="conversation-excerpt__chip"
      data-bitfun-product-component="conversation-excerpt" data-bitfun-product-part="chip"
      ...
      <Button ref={triggerRef} variant="text" size="sm" className="conversation-excerpt__attachment"
        data-bitfun-product-component="conversation-excerpt" data-bitfun-product-part="attachment"
    ...
    {open && createOverlayPortal(<Card ref={popoverRef} id={id} role="dialog" aria-label={countLabel}
      ...
      data-bitfun-product-component="conversation-excerpt" data-bitfun-product-part="details"
      data-flowchat-selection-ignore="true" data-bitfun-native-webview-occlusion
      ...
      {excerpts.map(excerpt => {
        ...
        return <div key={excerpt.id} className="conversation-excerpt__detail"
          data-bitfun-product-component="conversation-excerpt" data-bitfun-product-part="detail">
          <span className="conversation-excerpt__detail-number"
            data-bitfun-product-component="conversation-excerpt" data-bitfun-product-part="detailNumber">{number ? `${formatNumber(number)}.` : ''}</span>
          <div className="conversation-excerpt__detail-text"
            data-bitfun-product-component="conversation-excerpt" data-bitfun-product-part="detailText">
            <span className="conversation-excerpt__detail-label"
              data-bitfun-product-component="conversation-excerpt" data-bitfun-product-part="detailLabel">{t('context.selection')}</span>
            <div>{excerptText(excerpt)}</div>
            {excerpt.comment?.trim() && <><span className="conversation-excerpt__detail-label"
              data-bitfun-product-component="conversation-excerpt" data-bitfun-product-part="detailLabel">{t('selection.annotation')}</span>
...
export function ConversationExcerptPreview({ excerpt, superscript = false, origin = 'sent' }: {
  ...
  return <span data-bitfun-product-component="conversation-excerpt" data-bitfun-product-part="preview"
    ...
    {superscript ? <Button size="xs" variant="primary" labelBehavior="static" className="conversation-excerpt__superscript"
      data-bitfun-product-component="conversation-excerpt" data-bitfun-product-part="superscript"
