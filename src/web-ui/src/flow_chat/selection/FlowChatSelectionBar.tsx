  ...
  return (
    <>
      {selection && active && !editing && createOverlayPortal(
        <Card appearance="raised" radius="lg" data-bitfun-product-component="conversation-excerpt" data-bitfun-product-part="root"
          ref={popupRef} className="conversation-excerpt__popover" data-flowchat-selection-ignore="true" data-bitfun-native-webview-occlusion
          style={{ left: position?.left ?? 0, top: position?.top ?? 0, visibility: position ? 'visible' : 'hidden' }}>
          <ToolbarGroup data-bitfun-product-component="conversation-excerpt" data-bitfun-product-part="toolbar" className="conversation-excerpt__toolbar"
            role="group" aria-label={t('selection.actions')}>
            <Button size="sm" variant="text" className="conversation-excerpt__action"
              data-bitfun-product-component="conversation-excerpt" data-bitfun-product-part="action"
      ...
      <Dialog ref={editorRef} open={!!selection && editing && active} onOpenChange={clear} size="sm" className="conversation-excerpt__dialog"
        ...
        data-bitfun-product-component="conversation-excerpt" data-bitfun-product-part="dialog"
        onKeyDown={event => {
        ...
        <DialogBody>
          <div className="conversation-excerpt__editor"
            data-bitfun-product-component="conversation-excerpt" data-bitfun-product-part="editor">
