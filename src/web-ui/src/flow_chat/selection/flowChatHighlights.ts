const definitions = {
  excerpt: { name: 'bitfun-flowchat-excerpt', attribute: 'data-flowchat-highlight-excerpt' },
  annotations: { name: 'bitfun-flowchat-annotations', attribute: 'data-flowchat-highlight-annotations' },
  'search-match': { name: 'bitfun-flowchat-search-match', attribute: 'data-flowchat-highlight-search-match' },
  'search-current': { name: 'bitfun-flowchat-search-current', attribute: 'data-flowchat-highlight-search-current' },
} as const;
