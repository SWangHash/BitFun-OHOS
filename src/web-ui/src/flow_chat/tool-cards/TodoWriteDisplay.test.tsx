...
describe('TodoWriteDisplay expansion', () => {
  ...
  beforeEach(() => {
    ...
    vi.spyOn(HTMLElement.prototype, 'getBoundingClientRect').mockImplementation(function () {
      const height = (this as HTMLElement).querySelector?.('[data-bitfun-part="todoList"]') ? 320 : 64;
      return {
        bottom: height,
        height,
        left: 0,
  ...
  it('stays collapsed during streaming until the user expands it', () => {
    ...
    expect(container.querySelector('[data-bitfun-part="todoList"]')).toBeNull();
    ...
    expect(container.querySelector('[data-bitfun-part="todoList"]')).not.toBeNull();
  ...
  it('shows the first task when all tasks are pending', () => {
    ...
    const summary = container.querySelector('[data-bitfun-tool-card="todo"] [data-bitfun-part="summary"]');
