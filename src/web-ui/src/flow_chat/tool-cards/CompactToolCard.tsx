...
export const CompactToolCard: React.FC<CompactToolCardProps> = ({
  ...
  if (shouldRenderExpandedShell) {
    return (
      <BaseToolCard
        ...
        headerExpandAffordance={clickable || Boolean(onClick) || Boolean(onMouseUp)}
  ...
  return (
    <div data-bitfun-component="compact-tool-card" data-bitfun-part="root" data-bitfun-status={status}
      data-bitfun-state={[loadingShimmer && 'loading', clickable && 'clickable', isExpanded && 'expanded'].filter(Boolean).join(' ')}
    ...
    >
      <div
        data-bitfun-component="compact-tool-card"
      ...
      <SmoothHeightCollapse isOpen={Boolean(isExpanded && expandedContent)} className="compact-tool-card-expanded-collapse">
        <div data-bitfun-component="compact-tool-card" data-bitfun-part="expanded" className="compact-tool-card-expanded">
          {expandedContent}
        </div>
...
export const CompactToolCardHeader: React.FC<CompactToolCardHeaderProps> = ({
  ...
  return (
    <>
      ...
      {action && <span data-bitfun-component="compact-tool-card" data-bitfun-part="action" className="compact-card-action">{action}</span>}
      {content && <span data-bitfun-component="compact-tool-card" data-bitfun-part="content" className="compact-card-content">{content}</span>}
      {extra && <span data-bitfun-component="compact-tool-card" data-bitfun-part="extra" className="compact-card-extra">{extra}</span>}
      {rightStatusIcon && (
        <ToolCardStatusIcon
