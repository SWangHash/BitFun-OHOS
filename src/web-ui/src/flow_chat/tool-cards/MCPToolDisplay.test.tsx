...
describe('MCPToolDisplay', () => {
  ...
  it('can expand a completed call that has parameters but no result content', () => {
    ...
    const toggle = container.querySelector<HTMLButtonElement>('[data-bitfun-component="flow-chat-tool-card"][data-bitfun-part="affordanceButton"]');
  ...
  it('keeps failed calls collapsed until the user expands their parameters', () => {
    ...
    act(() => {
      container.querySelector<HTMLButtonElement>('[data-bitfun-component="flow-chat-tool-card"][data-bitfun-part="affordanceButton"]')?.dispatchEvent(
        new dom.window.MouseEvent('click', { bubbles: true })
      );
    });
  ...
  it('does not expose incomplete streaming parameters as expandable details', () => {
    ...
    expect(container.querySelector('[data-bitfun-component="flow-chat-tool-card"][data-bitfun-part="affordanceButton"]')).toBeNull();
    expect(container.querySelector('.mcp-input-code')).toBeNull();
  });
