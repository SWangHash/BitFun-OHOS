...
import { ControlDiscoveryError, loadAllBitFunControlResults } from './bitFunControlDiscovery';
import type { BitFunControlCardModel } from './bitFunControlCardModel';
...
export function useBitFunControlDiscovery(toolItem: FlowToolItem, model: BitFunControlCardModel, expanded: boolean) {
  ...
  useEffect(() => {
    ...
    void loadAllBitFunControlResults(request, model.result, surface, controller.signal)
      .then(items => {
