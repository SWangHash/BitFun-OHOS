...
export const GenerativeWidgetToolCard: React.FC<ToolCardProps> = ({ toolItem, sessionId }) => {
  ...
  const summary = (
    <ProminentToolCardSummary
      ...
      extra={(
        <div data-bitfun-component="generative-widget-tool-card" data-bitfun-part="extra" className="generative-widget-card__extra">
          <span
  ...
  const previewInner = isFailed ? (
    <div data-bitfun-component="generative-widget-tool-card" data-bitfun-part="placeholder" data-bitfun-state="failed" className="generative-widget-card__placeholder generative-widget-card__placeholder--error">
      {toolResult?.error || t('toolCards.generativeUI.renderFailed')}
    </div>
  ) : widgetCode.trim().length > 0 ? (
    <div data-bitfun-component="generative-widget-tool-card" data-bitfun-part="preview" ref={previewRef} className="generative-widget-card__preview">
    ...
    <div data-bitfun-component="generative-widget-tool-card" data-bitfun-part="placeholder" className="generative-widget-card__placeholder">
      {t('toolCards.generativeUI.waitingForContent')}
    </div>
  );

  const expandedBody = (
    <div data-bitfun-component="generative-widget-tool-card" data-bitfun-part="captureRoot" ref={captureRootRef} className="generative-widget-card__capture-root">
      {previewInner}
    </div>
  );
