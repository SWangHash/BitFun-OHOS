...
import { SessionControlToolCard as SessionControlToolCardView } from '@bitfun/ui/flow-chat';
...
export const SessionControlToolCard: React.FC<ToolCardProps> = React.memo(({
  ...
  return (
    <div ref={cardRootRef} data-bitfun-adapter="session-control" data-tool-card-id={toolId ?? ''}>
