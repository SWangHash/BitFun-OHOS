...
export const InitMiniAppDisplay: React.FC<ToolCardProps> = ({ toolItem }) => {
  ...
  const renderSummary = () => (
    <ProminentToolCardSummary
      ...
      content={
        <span data-bitfun-component="mini-app-tool-display" data-bitfun-part="info" className="miniapp-tool-info">
          <span data-bitfun-component="mini-app-tool-display" data-bitfun-part="operation" className="operation-tag">
            {isLoading
          ...
          <OverflowText
            data-bitfun-component="mini-app-tool-display"
      ...
      extra={
        <>
          {success && appId && status === 'completed' && (
            <OverflowText data-bitfun-component="mini-app-tool-display" data-bitfun-part="output" className="output-summary" title={appId}>
              {appId}
            </OverflowText>
          )}
          {isFailed && (
            <div data-bitfun-component="mini-app-tool-display" data-bitfun-part="errorIndicator" className="error-indicator">
  ...
  const renderExpandedSuccess = () => {
    ...
    return (
      <div data-bitfun-component="mini-app-tool-display" data-bitfun-part="result" className="miniapp-result-container">
        <div data-bitfun-component="mini-app-tool-display" data-bitfun-part="rows" className="miniapp-result-rows" data-testid="chat-miniapp-file-list">
          <div data-bitfun-component="mini-app-tool-display" data-bitfun-part="row" className="miniapp-result-row">
            <span data-bitfun-component="mini-app-tool-display" data-bitfun-part="label" className="miniapp-result-label">{t('toolCards.initMiniApp.labelAppId')}</span>
            <OverflowText data-bitfun-component="mini-app-tool-display" data-bitfun-part="value" className="miniapp-result-value" title={appId}>
              {appId}
            </OverflowText>
          </div>
          {miniAppFiles.map(filePath => (
            <div
              ...
              data-path={filePath}
            >
              <span data-bitfun-component="mini-app-tool-display" data-bitfun-part="label" className="miniapp-result-label">{t('toolCards.initMiniApp.labelPath')}</span>
              <OverflowText data-bitfun-component="mini-app-tool-display" data-bitfun-part="value" className="miniapp-result-value" title={filePath}>
                {filePath}
              </OverflowText>
            </div>
          ))}
        </div>
        <div data-bitfun-component="mini-app-tool-display" data-bitfun-part="footer" className="miniapp-result-footer miniapp-action-buttons">
          <Button
            type="button"
            variant="outline"
            size="sm"
  ...
  const renderExpandedError = () => (
    <div data-bitfun-component="mini-app-tool-display" data-bitfun-part="error" className="error-content">
  ...
  return (
    <div data-bitfun-component="mini-app-tool-display" data-bitfun-part="root"
      data-bitfun-state={[isExpanded && 'expanded', isFailed && 'failed', isLoading && 'loading'].filter(Boolean).join(' ')}
      ref={cardRootRef}
