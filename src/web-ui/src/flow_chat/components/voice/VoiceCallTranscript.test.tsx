...
describe('continuous transcript history scrolling', () => {
  ...
  beforeEach(async () => {
    ...
    viewport = container.querySelector<HTMLDivElement>('[data-bitfun-part="conversation"]')!;
  ...
  it('removes transient activity without replacing the user message or its reading anchor', async () => {
    ...
    const bubble = entry.querySelector('[data-bitfun-part="userTranscript"]')!;
    ...
    expect(entry.querySelector('[data-bitfun-part="userTranscript"]')).toBe(bubble);
