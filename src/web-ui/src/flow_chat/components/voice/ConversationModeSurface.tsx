...
import { OverflowText, IconButton, VoiceCallIdentity, VoiceCallControls, VoiceCallHeader } from '@bitfun/ui';
  ...
  return (
    <div
      className={[
        ...
        className,
        integrated && 'bitfun-conversation-mode-surface--integrated',
      ].filter(Boolean).join(' ')}
    ...
    >
      {!isVoiceMode && renderHeader?.(integrated ? null : <IconButton
        ...
        icon={<span className="bitfun-conversation-mode-surface__logo" aria-hidden="true" />}
      ...
      />)}
      {integrated && <div ref={voiceHeaderRef} className="bitfun-conversation-mode-surface__voice-header" aria-hidden={!isVoiceMode}
        data-bitfun-component="conversation-mode-surface" data-bitfun-part="voiceHeader">
        <div className="bitfun-conversation-mode-surface__voice-header-content">
      ...
      >
        ...
        {integrated ? (typeof transcript === 'function' ? transcript(isVoiceMode ? 'voice' : 'chat') : transcript)
          : isVoiceMode && <RealtimeVoiceCallPanel onClose={onCloseVoice} onBack={() => setShowVoice(false)} />}
        ...
        <ConversationTextVisibilityContext.Provider value={!isVoiceMode}>
          {integrated ? <div ref={composerRef} className="bitfun-conversation-mode-surface__composer" aria-hidden={isVoiceMode}
            data-bitfun-component="conversation-mode-surface" data-bitfun-part="composer">
            <div className="bitfun-conversation-mode-surface__composer-content">{children}</div>
