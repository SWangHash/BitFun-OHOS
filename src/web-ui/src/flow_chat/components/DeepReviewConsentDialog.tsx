...
export function useDeepReviewConsent(): DeepReviewConsentControls {
  ...
  const renderLaunchSummary = useCallback((preview: ReviewTeamRunManifest) => {
    ...
    return (
      <div data-bitfun-component="deep-review-consent-dialog" data-bitfun-part="summary" className="deep-review-consent__summary">
        <div data-bitfun-component="deep-review-consent-dialog" data-bitfun-part="summaryHeader" className="deep-review-consent__summary-header">
          <span className="deep-review-consent__fact-title">
            {t('deepReviewConsent.summaryTitle')}
          </span>
        </div>

        <div data-bitfun-component="deep-review-consent-dialog" data-bitfun-part="summaryStats" className="deep-review-consent__summary-stats">
        ...
        <div data-bitfun-component="deep-review-consent-dialog" data-bitfun-part="impactGrid" className="deep-review-consent__impact-grid">
          <div>
        ...
        {preview.workspacePath && (
          <div data-bitfun-component="deep-review-consent-dialog" data-bitfun-part="strategy" className="deep-review-consent__strategy-control">
  ...
  const deepReviewConsentDialog = pendingConsent ? (
    ...
    >
      ...
      <div data-bitfun-component="deep-review-consent-dialog" data-bitfun-part="root" className="deep-review-consent">
        <div data-bitfun-component="deep-review-consent-dialog" data-bitfun-part="header" className="deep-review-consent__header">
          <div data-bitfun-component="deep-review-consent-dialog" data-bitfun-part="heading" className="deep-review-consent__heading">
          ...
          <DialogClose
            data-bitfun-component="deep-review-consent-dialog"
        ...
        <div data-bitfun-component="deep-review-consent-dialog" data-bitfun-part="footer" className="deep-review-consent__footer">
          <div data-bitfun-component="deep-review-consent-dialog" data-bitfun-part="actions" className="deep-review-consent__actions">
            <Button
              variant="fill"
              size="sm"
