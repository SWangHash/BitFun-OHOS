...
export const SessionFilesBadge: React.FC<SessionFilesBadgeProps> = ({
  ...
  return (
    <>
      <div data-bitfun-component="session-files-badge" data-bitfun-part="root" data-bitfun-state={isExpanded ? 'expanded' : undefined}
        ref={badgeRef}
      ...
      <div
        ...
        data-bitfun-part="reviewMenu"
      >
        <Tooltip content={reviewButtonTitle}>
          <span
            className="session-files-badge__review-trigger"
            data-bitfun-component="session-files-badge"
            data-bitfun-part="reviewTrigger"
            data-bitfun-state={isReviewMenuOpen ? 'open' : undefined}
          >
            <IconButton
      ...
      >
        {totalStats.totalAdditions > 0 && (
          <span className="session-files-badge__stats session-files-badge__stats--add" data-bitfun-component="session-files-badge" data-bitfun-part="stats">
            +{totalStats.totalAdditions}
          </span>
        )}
        {totalStats.totalDeletions > 0 && (
          <span className="session-files-badge__stats session-files-badge__stats--del" data-bitfun-component="session-files-badge" data-bitfun-part="stats">
      ...
      {showFileStatsSummary && isExpanded && createPortal(
        <div
          ...
          data-bitfun-placement={filePopoverLayout?.placement ?? 'bottom'}
          style={{
        ...
        >
          <div className="session-files-badge__popover-summary" data-bitfun-component="session-files-badge" data-bitfun-part="summary">
          ...
          <div className="session-files-badge__list" data-bitfun-component="session-files-badge" data-bitfun-part="list">
            {Array.from(fileStats.values()).map((stat) => (
              ...
              >
                ...
                {stat.error ? (
                  <span className="session-files-badge__file-error" data-bitfun-component="session-files-badge" data-bitfun-part="fileError">{stat.error}</span>
                ) : (
                  <span className="session-files-badge__file-stats" data-bitfun-component="session-files-badge" data-bitfun-part="fileStats">
                    {stat.additions > 0 && (
