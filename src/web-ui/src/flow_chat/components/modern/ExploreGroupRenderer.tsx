...
export const ExploreGroupRenderer: React.FC<ExploreGroupRendererProps> = React.memo(({
  ...
  return (
    <div data-bitfun-component="explore-group" data-bitfun-part="root" data-bitfun-state={isExpanded ? 'expanded' : undefined}
      ref={cardRootRef}
    ...
    >
      {allowManualToggle && (
        <div
          data-bitfun-component="explore-group"
        ...
        >
          ...
          <span data-bitfun-component="explore-group" data-bitfun-part="summary" className="explore-region__summary">{displaySummary}</span>
        </div>
      )}
      <SmoothHeightCollapse
        isOpen={isExpanded}
        data-bitfun-component="explore-group"
        data-bitfun-part="contentWrapper"
...
const ExploreItemRenderer = React.memo<ExploreItemRendererProps>(({ item, turnId, isLastItem }) => {
  ...
  switch (item.type) {
    ...
    case 'tool':
      return (
        <div data-bitfun-component="explore-group" data-bitfun-part="item" className="flowchat-flow-item" data-flow-item-id={item.id} data-flow-item-type="tool">
          <FlowToolCard
