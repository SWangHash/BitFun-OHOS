...
const FACET_ATTRIBUTE_PATTERN = /^data-bitfun-[a-z][a-z0-9-]*$/;
const STATE_SUFFIX_PATTERN = /^(?::(?:hover|active|focus-visible|focus-within|disabled)(?::not\(:disabled\))?|:has\(input:checked\)|\[data-bitfun-state~="[a-z][a-zA-Z0-9-]*"\])$/;
