...
function migrateLegacyOwnedTokenName(name: string): AppearanceThemeTokenName | null {
  ...
  if (name.startsWith('--bf-appearance-token-domain-')) {
    return `--bitfun-domain-${name.slice('--bf-appearance-token-domain-'.length)}`;
  }
  if (name.startsWith('--bf-appearance-token-language-')) {
    return `--bitfun-domain-language-${name.slice('--bf-appearance-token-language-'.length)}`;
  }
  if (name.startsWith('--bf-appearance-token-prism-')) {
    return `--bitfun-domain-prism-${name.slice('--bf-appearance-token-prism-'.length)}`;
  }
  const gitNames: Readonly<Record<string, AppearanceThemeTokenName>> = {
    '--bf-appearance-token-git-color-branch': '--bitfun-domain-git-branch',
    '--bf-appearance-token-git-color-branch-bg': '--bitfun-domain-git-branch-background',
    '--bf-appearance-token-git-color-branch-bg-hover': '--bitfun-domain-git-branch-background-hover',
    '--bf-appearance-token-git-color-changes': '--bitfun-domain-git-changes',
    '--bf-appearance-token-git-color-added': '--bitfun-domain-git-added',
    '--bf-appearance-token-git-color-deleted': '--bitfun-domain-git-deleted',
    '--bf-appearance-token-git-color-staged': '--bitfun-domain-git-staged',
  };
...
const LEGACY_COMPONENT_TOKEN_SOURCES: Readonly<Record<string, AppearanceThemeTokenName>> = {
  '--bf-appearance-token-config-page-section-bg': '--bitfun-component-config-page-section-background',
  '--bf-appearance-token-config-page-section-border': '--bitfun-component-config-page-section-border',
  '--bf-appearance-token-config-page-section-border-width': '--bitfun-component-config-page-section-border-width',
  '--bf-appearance-token-config-page-section-shadow': '--bitfun-component-config-page-section-shadow',
  '--bf-appearance-token-config-page-divider': '--bitfun-component-config-page-divider',
  '--bf-appearance-token-config-page-row-hover-bg': '--bitfun-component-config-page-row-hover-background',
  '--bf-appearance-token-scene-viewport-border-width': '--bitfun-component-scene-viewport-border-width',
  '--bf-appearance-token-badge-padding-y': '--bitfun-component-badge-padding-block',
};
