...
import { Button, Field, Icon, IconButton, Input, Select, Switch } from '@bitfun/ui';
          ...
          {config.sources.map((source, index) => {
            ...
            return (
              <ConfigCollectionItem
                key={source.id}
                label={label}
                badge={<span className="bitfun-collection-item__badge">{source.provider === 'skillhub' ? 'SkillHub' : source.provider === 'skills-sh' ? 'skills.sh' : source.provider}</span>}
