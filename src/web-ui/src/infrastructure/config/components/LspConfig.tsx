...
const LspConfig: React.FC = () => {
  ...
  return (
    <ConfigPageLayout className="bitfun-lsp-config" data-bitfun-component="lsp-config" data-bitfun-part="root">
      <ConfigPageHeader title={t('title')} subtitle={t('subtitle')} />

      <ConfigPageContent>
        {installMessage && (
          <div className="bitfun-lsp-config__message-container" data-bitfun-component="lsp-config" data-bitfun-part="message">
        ...
        >
          <div className="bitfun-lsp-config__plugins" data-bitfun-component="lsp-config" data-bitfun-part="plugins">
            <LspPluginList
