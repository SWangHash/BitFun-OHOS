...
export function MCPServerConfigDialog({ session, saving, onSave, onClose }: Props) {
  ...
  function field(label: string, key: keyof McpServerDraft, children: React.ReactNode, hint?: string) {
    return <div className="mcp-config-editor__field" data-bitfun-component="mcp-config-editor" data-bitfun-part="field">
      <label htmlFor={`${controlId}-${key}`}>{label}</label>
      {children}
      {hint && <p className="mcp-config-editor__hint" data-bitfun-component="mcp-config-editor" data-bitfun-part="hint">{hint}</p>}
    </div>;
  }
  ...
  function keyValues(key: 'env' | 'headers', label: string) {
    ...
    return <section className="mcp-config-editor__section" aria-label={label} data-bitfun-component="mcp-config-editor" data-bitfun-part="section">
      <span>{label}</span>
      {rows.map((row, index) => <div className="mcp-config-editor__key-value" key={index} data-bitfun-component="mcp-config-editor" data-bitfun-part="keyValue">
  ...
  return <Dialog open onOpenChange={open => { if (!open) close(); }} size="lg" closeOnEscape={!busy} closeOnPointerOutside={false}>
    ...
    <DialogBody>
      <div ref={formRef} className="mcp-config-editor" data-bitfun-component="mcp-config-editor" data-bitfun-part="root">
        <p className="mcp-config-editor__hint" data-bitfun-component="mcp-config-editor" data-bitfun-part="hint">{t('visual.scopeHint')}</p>
        {isImport ? <>
          ...
          <div className="mcp-config-editor__actions" data-bitfun-component="mcp-config-editor" data-bitfun-part="actions">
          ...
          <p className="mcp-config-editor__hint" data-bitfun-component="mcp-config-editor" data-bitfun-part="hint">{t('visual.importHint')}</p>
          {candidates?.map((candidate, index) => <div key={candidate.sourceId} className="mcp-config-editor__import-row" data-bitfun-component="mcp-config-editor" data-bitfun-part="importRow">
            ...
            {Object.prototype.hasOwnProperty.call(initial.document.mcpServers, candidate.targetId.trim()) && <span className="mcp-config-editor__hint" data-bitfun-component="mcp-config-editor" data-bitfun-part="hint">{t('visual.conflictingId')}</span>}
          </div>)}
        </> : <>
          <div className="mcp-config-editor__actions" data-bitfun-component="mcp-config-editor" data-bitfun-part="actions">
          ...
          {jsonMode ? <>
            ...
            <p className="mcp-config-editor__hint" data-bitfun-component="mcp-config-editor" data-bitfun-part="hint">{t('jsonEditor.secretWarning')}</p>
          </> : <>
            ...
            {draft.transport === 'stdio' ? <>
              ...
              <section className="mcp-config-editor__section" aria-label={t('visual.arguments')} data-bitfun-component="mcp-config-editor" data-bitfun-part="section">
                <span>{t('visual.arguments')}</span>
                {draft.args.map((argument, index) => <div key={index} className="mcp-config-editor__argument" data-bitfun-component="mcp-config-editor" data-bitfun-part="argument">
            ...
            <div
              ...
              data-bitfun-component="mcp-config-editor"
              data-bitfun-part="advanced"
            >
              <Disclosure
              ...
              >
                <div
                  ...
                  data-bitfun-component="mcp-config-editor"
                  data-bitfun-part="advancedFields"
                >
            ...
            <p className="mcp-config-editor__hint" data-bitfun-component="mcp-config-editor" data-bitfun-part="hint">{t('visual.credentialHint')}</p>
          </>}
          <p className="mcp-config-editor__hint" data-bitfun-component="mcp-config-editor" data-bitfun-part="hint">{isNew ? t('visual.newServerHint') : t('visual.applyHint')}</p>
        </>}
        {error && <p id={`${controlId}-error`} className="mcp-config-editor__error" role="alert" data-bitfun-component="mcp-config-editor" data-bitfun-part="error">{errorMessages[error.code]}</p>}
        {saveFailed && <p className="mcp-config-editor__error" role="alert" data-bitfun-component="mcp-config-editor" data-bitfun-part="error">{t('visual.saveFailed')}</p>}
        {fileReadFailed && <p className="mcp-config-editor__error" role="alert" data-bitfun-component="mcp-config-editor" data-bitfun-part="error">{t('visual.fileReadFailed')}</p>}
      </div>
    </DialogBody>
