...
const footerSurfaces: FooterSurfaceContract[] = [
  ...
  },
  {
    ...
    marker: 'className="bitfun-skills-scene__modal-form-actions"',
  ...
  },
  {
    ...
    marker: 'className="bitfun-debug-config__modal-footer"',
  },
  {
