...
import { DesignSystemProvider, Dialog, OverlayLayer, OverlayRegion, Portal, MenuPopover, subscribeOverlayInteraction } from '@bitfun/ui';

globalThis.IS_REACT_ACT_ENVIRONMENT = true;
const slot = (id: string) => document.querySelector(`[data-test-layer="${id}"]`)!.closest<HTMLElement>('[data-bitfun-overlay-layer]')!;
...
describe('document overlay ownership', () => {
  ...
  afterEach(() => {
    ...
    document.querySelectorAll('[data-bitfun-overlay-host]').forEach(element => element.remove());
  ...
  it('shares the coordinator across separately loaded package instances', async () => {
    ...
    vi.resetModules();
    const reloadedEntry = await import('@bitfun/ui');
