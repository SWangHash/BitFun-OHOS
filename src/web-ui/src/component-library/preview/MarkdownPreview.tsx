...
export const MarkdownPreview: React.FC = () => {
  ...
  return (
    <div className="markdown-preview-page" data-bitfun-component="component-preview" data-bitfun-part="markdownRoot">
      <header className="markdown-preview-header" data-bitfun-component="component-preview" data-bitfun-part="markdownHeader">
      ...
      <div className="markdown-controls" data-bitfun-component="component-preview" data-bitfun-part="markdownControls">
      ...
      <div className="markdown-preview-main">
        {activeTab === 'preview' ? (
          <div className="preview-container" data-bitfun-component="component-preview" data-bitfun-part="markdownStage">
            <Markdown content={content} variant={variant} />
          </div>
        ) : (
          <div className="editor-container" data-bitfun-component="component-preview" data-bitfun-part="markdownStage">
            <textarea
              ...
              data-bitfun-part="markdownEditor"
            />
          </div>
        )}
      </div>
