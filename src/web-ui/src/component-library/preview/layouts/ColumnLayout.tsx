...
export const ColumnLayout: React.FC<ColumnLayoutProps> = ({ components }) => {
  ...
  return (
    <div className="column-layout" data-bitfun-component="component-preview" data-bitfun-part="columnRoot">
      <div className="column-nav" data-bitfun-component="component-preview" data-bitfun-part="columnNavigation">
      ...
      <div className="column-content">
        {components.map((component) => (
          ...
          >
            ...
            <div className="column-item-preview" data-bitfun-component="component-preview" data-bitfun-part="columnPreview">
              <component.component />
            </div>
          </div>
        ))}
