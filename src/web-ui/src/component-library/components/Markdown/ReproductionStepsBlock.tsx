...
export const ReproductionStepsBlock: React.FC<ReproductionStepsBlockProps> = ({
  ...
  return (
    <div className={`reproduction-steps-block ${hasProceeded ? 'proceeded' : ''} ${showContent ? 'expanded' : 'collapsed'}`} data-bitfun-component="markdown" data-bitfun-part="reproduction" data-bitfun-state={showContent ? 'expanded' : undefined}>
      <div 
        className={`reproduction-steps-header ${hasProceeded ? 'clickable' : ''}`}
        data-bitfun-component="markdown"
        data-bitfun-part="reproductionHeader"
      ...
      {showContent && (
        <>
          <div className="reproduction-steps-content" data-bitfun-component="markdown" data-bitfun-part="reproductionContent">
          ...
          {!hasProceeded && (
            <div className="reproduction-steps-actions" data-bitfun-component="markdown" data-bitfun-part="reproductionActions">
