...
export const BaseToolCard: React.FC<BaseToolCardProps> = ({
  ...
  if (displayMode === 'compact') {
    return (
      <div 
        ...
        data-bitfun-status={currentStatus}
        style={{ '--base-tool-card-accent-color': primaryColor } as React.CSSProperties}
      >
        <div className="base-tool-card__compact-content" data-bitfun-component="flow-chat-card" data-bitfun-part="compact">
          {typeof icon === 'string' ? (
          ...
          {children}
          <span className="base-tool-card__status" data-bitfun-component="flow-chat-card" data-bitfun-part="status">{getStatusIcon()}</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div 
      ...
      data-bitfun-component="flow-chat-card"
      data-bitfun-part="root"
      data-bitfun-display={displayMode}
      data-bitfun-status={currentStatus}
      style={{ '--base-tool-card-accent-color': primaryColor } as React.CSSProperties}
    >
      <div className="base-tool-card__header" data-bitfun-component="flow-chat-card" data-bitfun-part="header">
        ...
        <div className="base-tool-card__status-container" data-bitfun-component="flow-chat-card" data-bitfun-part="status">
      ...
      {children && (
        <div className="base-tool-card__content" data-bitfun-component="flow-chat-card" data-bitfun-part="content">
          {children}
        </div>
      )}
      ...
      {requiresConfirmation && !userConfirmed && currentStatus !== 'completed' && (
        <div className="base-tool-card__actions" data-bitfun-component="flow-chat-card" data-bitfun-part="actions">
          <button 
      ...
      {result && (
        <div className="base-tool-card__result" data-bitfun-component="flow-chat-card" data-bitfun-part="result">
      ...
      {error && (
        <div className="base-tool-card__error" data-bitfun-component="flow-chat-card" data-bitfun-part="error">
