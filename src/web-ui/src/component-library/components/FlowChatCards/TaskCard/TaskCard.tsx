...
export const TaskCard: React.FC<TaskCardProps> = ({
  ...
  if (displayMode === 'compact') {
    return (
      <div className={`task-card task-card--compact task-card--${status}`} data-bitfun-component="flow-chat-card" data-bitfun-part="compact" data-bitfun-display="compact" data-bitfun-status={status}>
  ...
  return (
    <BaseToolCard
      ...
      input={input}
      result={result}
      primaryColor="var(--bf-appearance-token-color-purple-600)"
      className="task-card"
      {...baseProps}
    >
      ...
      {status === 'completed' && resolvedResult && (
        <div className="task-card__result-section" data-bitfun-component="flow-chat-card" data-bitfun-part="result">
          <button
      ...
      {(status === 'running' || status === 'streaming') && (
        <div className="task-card__executing" data-bitfun-component="flow-chat-card" data-bitfun-part="processing">
