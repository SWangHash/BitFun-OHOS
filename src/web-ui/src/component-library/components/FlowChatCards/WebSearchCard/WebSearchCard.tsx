...
export const WebSearchCard: React.FC<WebSearchCardProps> = ({
  ...
  const cardColor = APPEARANCE_DOMAIN_TOKENS.toolIdentity.webSearch;
  ...
  return (
    ...
    >
      <div style={{ '--private-web-search-card-identity-color': cardColor } as React.CSSProperties}>
        ...
        {status === 'completed' && resolvedResults.length > 0 && (
          <div className="web-search-card__results-section" data-bitfun-component="flow-chat-card" data-bitfun-part="result">
            <button
            ...
            {isExpanded && (
              <div className="web-search-card__results-list" data-bitfun-component="flow-chat-card" data-bitfun-part="list">
                {resolvedResults.map((item: WebSearchResult, index: number) => (
                  <div key={index} className="web-search-card__result-item" data-bitfun-component="flow-chat-card" data-bitfun-part="item">
        ...
        {status === 'completed' && resolvedResults.length === 0 && (
          <div className="web-search-card__no-results" data-bitfun-component="flow-chat-card" data-bitfun-part="empty">
            {t('flowChatCards.webSearchCard.noResults')}
          </div>
        )}

        {(status === 'running' || status === 'streaming') && (
          <div className="web-search-card__searching" data-bitfun-component="flow-chat-card" data-bitfun-part="processing">
