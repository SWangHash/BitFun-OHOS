...
export const ContextCompressionCard: React.FC<ContextCompressionCardProps> = ({
  ...
  if (displayMode === 'compact') {
    return (
      <div className={`context-compression-card context-compression-card--compact status-${status}`} data-bitfun-component="context-compression-card" data-bitfun-part="compact" data-bitfun-display="compact" data-bitfun-status={status}>
        <span className="context-compression-card__status-icon" data-bitfun-component="context-compression-card" data-bitfun-part="status">{getStatusIcon(14)}</span>
        
        <span className="context-compression-card__action" data-bitfun-component="context-compression-card" data-bitfun-part="action">
        ...
        {resolvedTokensBefore !== undefined && resolvedTokensAfter !== undefined && (
          <span className="context-compression-card__tokens" data-bitfun-component="context-compression-card" data-bitfun-part="tokens">
        ...
        {status === 'completed' && savedTokens !== undefined && savedRatio !== undefined && (
          <span className="context-compression-card__result" data-bitfun-component="context-compression-card" data-bitfun-part="result">
  ...
  return (
    ...
    >
      {(status === 'running' || status === 'streaming') && (
        <div className="context-compression-card__processing" data-bitfun-component="context-compression-card" data-bitfun-part="processing">
      ...
      {status === 'completed' && (
        <>
          <div className="context-compression-card__simple-row" data-bitfun-component="context-compression-card" data-bitfun-part="summaryRow">
          ...
          {resolvedTokensBefore !== undefined && resolvedTokensAfter !== undefined && (
            <div className="context-compression-card__simple-row context-compression-card__simple-row--stats" data-bitfun-component="context-compression-card" data-bitfun-part="statsRow">
