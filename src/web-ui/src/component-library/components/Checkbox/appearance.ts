...
export const checkboxAppearanceDescriptor: AppearanceSurfaceDescriptor = {
  ...
  states: [
    ...
    { id: 'indeterminate', selector: { kind: 'ancestorPart', part: 'root', suffix: '[data-openbitfun-state~="indeterminate"]' } },
    { id: 'disabled', selector: { kind: 'ancestorPart', part: 'root', suffix: '[data-openbitfun-state~="disabled"]' } },
