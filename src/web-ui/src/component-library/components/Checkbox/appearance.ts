...
export const checkboxAppearanceDescriptor: AppearanceSurfaceDescriptor = {
  ...
  states: [
    ...
    { id: 'indeterminate', selector: { kind: 'ancestorPart', part: 'root', suffix: '[data-bitfun-state~="indeterminate"]' } },
    { id: 'disabled', selector: { kind: 'ancestorPart', part: 'root', suffix: '[data-bitfun-state~="disabled"]' } },
