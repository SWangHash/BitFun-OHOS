...
export const selectAppearanceDescriptor: AppearanceSurfaceDescriptor = {
  ...
  facets: [{ id: 'size', attribute: 'data-openbitfun-size', values: ['small', 'medium', 'large'] }, { id: 'placement', attribute: 'data-openbitfun-placement', values: ['top', 'bottom'] }, { id: 'multiple', attribute: 'data-openbitfun-multiple', values: ['true', 'false'] }],
  states: [{ id: 'hover', selector: { kind: 'self', suffix: ':hover' } }, { id: 'focusWithin', selector: { kind: 'self', suffix: ':focus-within' } }, { id: 'open', selector: { kind: 'self', suffix: '[data-openbitfun-state~="open"]' } }, { id: 'selected', selector: { kind: 'self', suffix: '[data-openbitfun-state~="selected"]' } }, { id: 'highlighted', selector: { kind: 'self', suffix: '[data-openbitfun-state~="highlighted"]' } }, { id: 'disabled', selector: { kind: 'self', suffix: '[data-openbitfun-state~="disabled"]' } }, { id: 'error', selector: { kind: 'self', suffix: '[data-openbitfun-state~="error"]' } }, { id: 'loading', selector: { kind: 'self', suffix: '[data-openbitfun-state~="loading"]' } }],
};
