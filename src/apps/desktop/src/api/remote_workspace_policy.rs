...
pub const REMOTE_WORKSPACE_COMMAND_POLICIES: &[(&str, RemoteWorkspacePolicy)] = &[
    ...
    (
        "browser_webview_set_background_color",
        RemoteWorkspacePolicy::LocalOnly,
    ),
    ...
    // Knowledge bases are user-level local data under `U/data/knowledge`,
    // independent of the active workspace, so every command runs on the local
    // host. Remote workspace routing is intentionally out of scope for now.
    ("knowledge_create_base", RemoteWorkspacePolicy::LocalOnly),
    ("knowledge_list_bases", RemoteWorkspacePolicy::LocalOnly),
    ("knowledge_get_base", RemoteWorkspacePolicy::LocalOnly),
    ("knowledge_delete_base", RemoteWorkspacePolicy::LocalOnly),
    ("knowledge_add_items", RemoteWorkspacePolicy::LocalOnly),
    ("knowledge_list_items", RemoteWorkspacePolicy::LocalOnly),
    ("knowledge_delete_items", RemoteWorkspacePolicy::LocalOnly),
    ("knowledge_reindex_items", RemoteWorkspacePolicy::LocalOnly),
    ("knowledge_search", RemoteWorkspacePolicy::LocalOnly),
    (
        "knowledge_list_item_chunks",
        RemoteWorkspacePolicy::LocalOnly,
    ),
    ("knowledge_get_file_path", RemoteWorkspacePolicy::LocalOnly),
