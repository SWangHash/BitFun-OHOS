...
async fn permission_project_id_for_workspace(
    ...
    let binding = bitfun_core::agentic::workspace::WorkspaceBinding::resolve(&workspace.id)
        .await
...
pub async fn list_sessions(
    ...
    let effective_path = if let Some(id) = request.workspace_id.as_deref() {
        ...
        bitfun_core::agentic::session::CoreSessionStorePort::default()
...
fn local_mode_catalog_scope(
    record: &bitfun_core::service::workspace::WorkspaceInfo,
) -> Option<DesktopSessionScopeRequest> {
    if record.workspace_kind == bitfun_core::service::workspace::WorkspaceKind::Remote {
        return None;
    }
...
pub async fn ensure_control_conversation(
    coordinator: State<'_, Arc<ConversationCoordinator>>,
) -> Result<bitfun_core::agentic::coordination::ControlConversation, String> {
    coordinator
...
pub async fn create_control_conversation(
    coordinator: State<'_, Arc<ConversationCoordinator>>,
    request: bitfun_core::agentic::coordination::CreateControlConversationRequest,
) -> Result<bitfun_core::agentic::coordination::ControlConversation, String> {
    coordinator
...
pub async fn record_voice_exchange(
    coordinator: State<'_, Arc<ConversationCoordinator>>,
    request: bitfun_core::agentic::coordination::VoiceExchangeRequest,
) -> Result<(), String> {
    coordinator
