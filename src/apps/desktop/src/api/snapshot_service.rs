...
use bitfun_core::agentic::workspace::WorkspaceBinding;
...
use bitfun_runtime_ports::{AgentSessionWorkspaceLocation, SessionStorePort};
use log::{info, warn};
...
async fn begin_snapshot_history_read_for_scope(
    ...
    let storage_path = bitfun_core::agentic::session::CoreSessionStorePort::default()
...
pub async fn rollback_session_to_turn(
    runtime: State<'_, DesktopRuntimeContext>,
    mut request: bitfun_runtime_ports::AgentSessionRollbackToTurnRequest,
