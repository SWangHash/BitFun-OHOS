...
import com.bitfun.mobile.app.ui.shell.WelcomeBrandFlow
...
private fun RemoteConnectedScreen(
    ...
    val conversation = requestedSessionId?.takeIf { remoteState !is RemoteSessionUiState.Failed }?.let { requested ->
        ...
        if (matches) ready else RemoteSessionUiState.Ready(
            ...
            query = "", agentFilter = com.bitfun.mobile.core.feature.session.SessionAgentFilter.ALL,
    ...
    if (conversation != null) {
        ...
        Column(modifier.fillMaxSize()) {
            ...
            Column(Modifier.weight(1f).fillMaxWidth().padding(24.dp),
                ...
                TextButton(onClick = {
                    onSessionIntent(com.bitfun.mobile.core.feature.session.RemoteSessionIntent.Open(requestedSessionId))
        ...
        RemoteCompactHome(
            ...
            onOpen = { id ->
                onOpenSession(id)
                onSessionIntent(com.bitfun.mobile.core.feature.session.RemoteSessionIntent.Open(id))
            },
            onOpenRemoteSettings = onOpenRemoteSettings,
            modifier = modifier,
        )
