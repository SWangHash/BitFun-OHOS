...
import com.bitfun.mobile.app.platform.prepareComposerImage
...
internal fun mergeComposerDraft(existing: String, spoken: String): String =
    com.bitfun.mobile.core.feature.session.VoiceDraftPolicy.merge(existing, spoken)
...
internal fun ConversationView(
    ...
    val attachments: com.bitfun.mobile.app.viewmodel.ComposerAttachmentsViewModel =
    ...
    androidx.compose.runtime.CompositionLocalProvider(
        com.bitfun.mobile.app.ui.chat.tool.LocalPlanActions provides com.bitfun.mobile.app.ui.chat.tool.PlanActions(
...
@Composable
private fun PermissionMailboxView(state: com.bitfun.mobile.core.feature.session.PermissionMailboxUiState, sessionId: String, onIntent: (RemoteSessionIntent) -> Unit) {
    Column {
        ...
        com.bitfun.mobile.app.ui.chat.tool.ToolStatusList(listOf(question), enabled = !state.busy,
