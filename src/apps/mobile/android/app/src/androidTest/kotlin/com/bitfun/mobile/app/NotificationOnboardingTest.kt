...
import com.bitfun.mobile.app.platform.NotificationOnboarding as OnboardingStore
import com.bitfun.mobile.app.ui.shell.NotificationOnboarding
        ...
        try {
            ...
            composeRule.setContent {
                ...
                CompositionLocalProvider(
                    ...
                    BitFunTheme(dark = false) { NotificationOnboarding() }
                }
            }
