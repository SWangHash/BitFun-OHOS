...
import com.bitfun.mobile.app.ui.remote.RuntimeTerminalDialog
...
class RuntimeTerminalViewTest {
    ...
    @Test fun terminalControlsFollowSharedCloseStateAndOfferScopedReopen() {
        ...
        compose.setContent {
            BitFunTheme(dark = false) { RuntimeTerminalDialog(state.value, { intents += it }, {}) }
        }
