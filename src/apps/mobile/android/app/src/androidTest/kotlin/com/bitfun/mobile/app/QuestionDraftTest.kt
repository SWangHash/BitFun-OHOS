...
import com.bitfun.mobile.app.ui.chat.PermissionMailboxView
import com.bitfun.mobile.core.feature.session.*
import androidx.compose.ui.test.*
import androidx.compose.ui.test.junit4.v2.createComposeRule
import androidx.test.platform.app.InstrumentationRegistry
import com.bitfun.mobile.app.ui.chat.tool.ToolQuestionAnswerPanel
...
class QuestionDraftTest {
    ...
    @Test fun mailboxOwnsTheOnlyAnswerFormWhileTranscriptKeepsItsSummary() {
        ...
        compose.setContent {
            BitFunTheme(dark = false) {
                androidx.compose.runtime.CompositionLocalProvider(
                    com.bitfun.mobile.app.ui.chat.tool.LocalPermissionMailbox provides mailbox.value,
                ) {
                    androidx.compose.foundation.layout.Column {
                        PermissionMailboxView(mailbox.value, "session", 400.dp) {}
                        com.bitfun.mobile.app.ui.chat.tool.ToolStatusList(
        ...
        compose.onNodeWithTag(com.bitfun.mobile.app.ui.chat.tool.TOOL_ROW_TEST_TAG).assertExists()
