...
import com.bitfun.mobile.app.ui.common.connectionSheetTextStyle
import com.bitfun.mobile.app.ui.common.ConnectionSheetHeader
import com.bitfun.mobile.app.ui.common.ConnectionSheetFooter
...
class ConnectionSheetChromeTest {
    ...
    @Test fun compactLoginKeepsContentGeometryAtPhoneAndWideWidths() {
        ...
        composeRule.setContent {
            BitFunTheme(dark = false) {
                com.bitfun.mobile.app.ui.account.AccountLoginPage(
                    state = com.bitfun.mobile.core.feature.account.AccountUiState.SignedOut,
                    onBack = {}, onLogin = {},
