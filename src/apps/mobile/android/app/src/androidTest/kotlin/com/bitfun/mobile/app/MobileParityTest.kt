...
import com.bitfun.mobile.app.ui.chat.*
import com.bitfun.mobile.app.ui.chat.tool.*
import com.bitfun.mobile.app.ui.miniapps.BuiltinMiniAppBridge
import com.bitfun.mobile.app.ui.theme.BitFunTheme
import com.bitfun.mobile.core.feature.connection.ConnectionPhase
import com.bitfun.mobile.core.feature.session.*
...
class MobileParityTest {
    ...
    @Test fun preparedAttachmentsSurviveNewStoresAndStayDeviceScoped() {
        ...
        val first = com.bitfun.mobile.app.viewmodel.ComposerAttachmentsViewModel()
        lateinit var draft: com.bitfun.mobile.app.viewmodel.ComposerAttachmentsViewModel.AttachmentDraft
        ...
        val restored = com.bitfun.mobile.app.viewmodel.ComposerAttachmentsViewModel()
        lateinit var reloaded: com.bitfun.mobile.app.viewmodel.ComposerAttachmentsViewModel.AttachmentDraft
        lateinit var other: com.bitfun.mobile.app.viewmodel.ComposerAttachmentsViewModel.AttachmentDraft
        rule.runOnIdle {
        ...
        val legacy = com.bitfun.mobile.app.viewmodel.ComposerAttachmentsViewModel()
        ...
        val corrupt = com.bitfun.mobile.app.viewmodel.ComposerAttachmentsViewModel()
    ...
    private fun captureOfflineMiniApp(index: Int) {
        ...
        rule.setContent { BitFunTheme(dark = false) { com.bitfun.mobile.app.ui.miniapps.MiniAppsButton() } }
