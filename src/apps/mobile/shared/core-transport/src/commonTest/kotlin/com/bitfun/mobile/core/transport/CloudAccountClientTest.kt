...
import com.bitfun.mobile.core.crypto.DeviceIdentity
...
class CloudAccountClientTest {
    ...
    fun authorizationAcceptsTheIdentityAuthorityGithubUrlAndRejectsOtherDestinations() = runTest {
        for (url in listOf("https://github.com/login/oauth/authorize?state=test", "https://auth.bitfun.com/sign-in#ticket=test", "https://auth.bitfun.com.evil.example/sign-in", "https://user@auth.bitfun.com/sign-in", "https://auth.bitfun.com:444/sign-in", "https://github.com.evil.example/login/oauth/authorize", "https://github.com/login", "https://user@github.com/login/oauth/authorize", "http://github.com/login/oauth/authorize")) {
            ...
            if (url == "https://github.com/login/oauth/authorize?state=test" || url == "https://auth.bitfun.com/sign-in#ticket=test") assertEquals(url, client.startAuthorization(DEFAULT_CLOUD_RELAY_URL).authorizationUrl)
    ...
    fun githubLoginRegistersOnlyThePublicDeviceKey() = runTest {
        ...
        val engine = MockEngine { request ->
            assertEquals("https://remote.bitfun.com/v/1.0.1/api/auth/login", request.url.toString())
