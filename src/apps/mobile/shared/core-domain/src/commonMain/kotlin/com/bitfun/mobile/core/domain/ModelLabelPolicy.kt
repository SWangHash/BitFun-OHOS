 ...
 * vendor name (`anthropic`, `bitfun/claude-opus-4`, …), so both lines are
...
public object ModelLabelPolicy {
    ...
    private val BITFUN_PREFIX = Regex("^bitfun[:/_-]+", RegexOption.IGNORE_CASE)
    private val ANTHROPIC_PREFIX = Regex("^anthropic[:/_-]+", RegexOption.IGNORE_CASE)
    private val VENDOR_NAMES = setOf("bitfun", "anthropic", "openai", "google", "azure")
}
