...
final class MobileCoreAdapter {
    ...
    var onRemoteConnectionPhase: ((BitFunMobileCore.ConnectionPhase, String, UInt64) -> Void)?
    ...
    init(
        ...
        onRemoteConnectionPhase: ((BitFunMobileCore.ConnectionPhase, String, UInt64) -> Void)? = nil,
    ...
    private func bindRemoteStores(
        ...
        let connectionFlow = SkieSwiftStateFlow<BitFunMobileCore.ConnectionPhase>(sessionStore.connectionPhase)
