        ...
        HStack(spacing: 0) {
            ...
            Button { model.settingsOpen = true; model.drawerOpen = false } label: {
                Image(systemName: "gearshape")
                    ...
                    .background(BitFunTheme.card)
                    .clipShape(Circle())
                    .shadow(color: BitFunTheme.shadowSubtle, radius: 12, y: 4)
            }
            .buttonStyle(.plain)
                            ...
                            Button { onSelect(workspace) } label: {
                                HStack(spacing: 12) {
                                    ...
                                    Image(systemName: workspace.selected ? "checkmark" : "chevron.right")
                                        ...
                                        .foregroundStyle(workspace.selected ? BitFunTheme.ink : BitFunTheme.muted)
                                        .frame(width: 40, height: 40)
                                }
                                .padding(.leading, 10)
                                .padding(.trailing, 8)
                                .frame(height: 68)
                                .background(workspace.selected ? BitFunTheme.soft : BitFunTheme.page)
