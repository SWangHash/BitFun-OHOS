...
final class TimelineScrollController: ObservableObject {
    ...
    private let log = Logger(subsystem: "com.bitfun.mobile.ios", category: "timeline-scroll")
...
struct ThinkingLayoutProbe: UIViewRepresentable {
    ...
    final class ProbeView: UIView {
        ...
        private let log = Logger(subsystem: "com.bitfun.mobile.ios", category: "thinking-layout")
