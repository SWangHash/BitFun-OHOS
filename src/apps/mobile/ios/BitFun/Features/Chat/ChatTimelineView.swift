...
private struct MarkdownBlockView: View {
    ...
    var body: some View {
        ...
        case "quote":
            Text(inlineString(block.inlines))
                .font(MobileDesignTypography.bodyMedium.font).foregroundStyle(BitFunTheme.muted)
            ...
            VStack(alignment: .leading, spacing: 5) {
                ForEach(block.items, id: \.id) { item in
                    HStack(alignment: .firstTextBaseline, spacing: 7) {
                        ...
                        Text(inlineString(item.inlines)).foregroundStyle(BitFunTheme.ink)
                            .lineSpacing(MobileDesignTypography.bodyMedium.lineSpacing)
                            .textSelection(.enabled)
                    }
                    .font(MobileDesignTypography.bodyMedium.font)
        ...
        default:
            Text(inlineString(block.inlines))
                .font(MobileDesignTypography.bodyMedium.font).foregroundStyle(BitFunTheme.ink)
