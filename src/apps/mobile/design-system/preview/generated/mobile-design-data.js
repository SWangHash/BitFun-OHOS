...
export const mobileComponents = {
  ...
  "components": {
    ...
    "permission_request_panel": {
      ...
      "platformNotes": "Reference: desktop ChatInputApprovalBand and @bitfun/ui raised Card, neutral resource Card, fill reject Button and primary allow Button. Preserve desktop 12-unit card radius/padding and 8-unit gaps, with 36-unit mobile actions. Resource content scrolls within the band; actions do not stretch across the card. JSON editing remains a quiet, collapsed mobile-web capability. status_warning ports desktop amber.550 for the short shield glyph: neither success/danger nor the blue file-link accent communicates pending approval."
    }
  }
};
