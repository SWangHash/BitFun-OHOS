...
const messages = {
  'en-US': {
    accountSignIn: "Sign in to BitFun",
    ...
    authSharedIdentity: 'Use the same BitFun account for the marketplaces and remote device control.',
  ...
  'zh-CN': {
    ...
    authSharedIdentity: '市场与远程设备控制共用你的 BitFun 账号。',
    ...
    permissionAgent: '启动可见的 BitFun 智能体会话',
  ...
  'zh-TW': {
    ...
    authSharedIdentity: '市場與遠端裝置控制共用你的 BitFun 帳號。',
    ...
    permissionAgent: '啟動可見的 BitFun 智能體工作階段',
...
export function initialLocale(): Locale {
  ...
  try { stored = localStorage.getItem('bitfun-market-locale'); } catch { /* Storage can be blocked in an auth popup. */ }
...
export function useLocale() {
  ...
  useEffect(() => {
    ...
    try { localStorage.setItem('bitfun-market-locale', locale); } catch { /* Keep the selected language in memory. */ }
  }, [locale]);
  return {
    locale,
