...
settings with a disclosure that BitFun owns lifecycle after import. Source
...
- `cargo test --locked -p bitfun-dsh-adapter --lib mcp_source::tests`
- `cargo test --locked -p bitfun-dsh-adapter --lib hook_source::tests`
