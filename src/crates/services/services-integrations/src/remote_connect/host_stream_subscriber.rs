...
const UNSUPPORTED_HOST_MESSAGE: &str = "The controlled device runs an older BitFun version that does not support on-demand session streaming. Update BitFun on that device to continue.";
