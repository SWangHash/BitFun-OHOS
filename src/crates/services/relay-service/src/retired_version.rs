...
pub(crate) const MESSAGE: &str = "This Relay version has been retired. Update BitFun on this device, then sign in again to continue.";
/// The edge proxy sets this to the version prefix it forwards, e.g. `/v/1.0.1`.
pub(crate) const SERVED_PREFIX_HEADER: &str = "x-bitfun-relay-served-prefix";
