...
pub(crate) const MESSAGE: &str = "This relay does not store session history. Session records are read from the online host on demand; update BitFun on every device to continue.";
