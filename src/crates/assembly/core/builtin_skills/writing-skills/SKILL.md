...
**PRINCIPLE:** The same RED-GREEN-REFACTOR discipline applies to documentation. No skill without a failing test first.
...
**Examples:** test-driven workflows, pre-completion verification, design-first approaches
