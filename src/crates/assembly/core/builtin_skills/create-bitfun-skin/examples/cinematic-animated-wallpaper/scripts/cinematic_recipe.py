...
def build_renderers(colors: Mapping[str, str], appearance_id: str) -> dict[str, Any]:
    ...
    accent = colors["accent"]
    theme_tokens = {
        "--bitfun-color-surface-canvas": rgba(background, 0.78),
        "--bitfun-color-surface-panel": rgba(surface, 0.72),
        "--bitfun-color-surface-tertiary": rgba(elevated, 0.76),
        "--bitfun-color-surface-raised": rgba(elevated, 0.74),
        "--bitfun-color-surface-scene": rgba(background, 0.08),
        "--bitfun-color-surface-workbench": rgba(background, 0.08),
        "--bitfun-color-surface-chrome": rgba(background, 0.18),
        "--bitfun-color-surface-subtle": rgba(surface, 0.50),
        "--bitfun-color-action-quiet-hover": rgba(surface, 0.58),
        "--bitfun-color-action-neutral-surface": rgba(elevated, 0.66),
        "--bitfun-color-action-neutral-surface-hover": rgba(elevated, 0.70),
        "--bitfun-color-action-neutral-surface-pressed": rgba(elevated, 0.78),
        "--bitfun-color-content-primary": colors["text"],
        "--bitfun-color-content-secondary": colors["textSecondary"],
        "--bitfun-color-content-muted": colors["textMuted"],
        "--bitfun-color-content-disabled": colors["textDisabled"],
        "--bitfun-color-accent-default": accent,
        "--bitfun-color-accent-hover": colors["accentStrong"],
        "--bitfun-color-border-subtle": rgba(accent, 0.08),
        "--bitfun-color-border-default": rgba(accent, 0.12),
        "--bitfun-color-border-strong": rgba(accent, 0.28),
        "--bitfun-color-status-danger-content": colors["danger"],
        "--bitfun-color-status-danger-surface": rgba(colors["danger"], 0.28),
        "--bitfun-color-status-danger-border": rgba(colors["danger"], 0.38),
        "--bitfun-color-status-warning-content": colors["warning"],
        "--bitfun-color-status-success-content": colors["success"],
        "--bitfun-color-status-info-content": colors["info"],
        "--bitfun-color-scrollbar-thumb": rgba(accent, 0.22),
        "--bitfun-color-scrollbar-thumb-hover": rgba(accent, 0.38),
    }
    widget_tokens = {
        "--bitfun-color-surface-canvas": background,
        "--bitfun-color-surface-panel": surface,
        "--bitfun-color-surface-tertiary": elevated,
        "--bitfun-color-surface-raised": elevated,
        "--bitfun-color-surface-scene": background,
        "--bitfun-color-content-primary": colors["text"],
        "--bitfun-color-content-secondary": colors["textSecondary"],
        "--bitfun-color-content-muted": colors["textMuted"],
        "--bitfun-color-content-disabled": colors["textDisabled"],
        "--bitfun-color-accent-default": accent,
        "--bitfun-color-accent-hover": colors["accentStrong"],
        "--bitfun-color-border-subtle": rgba(accent, 0.08, spaced=False),
        "--bitfun-color-border-default": rgba(accent, 0.12, spaced=False),
        "--bitfun-color-border-strong": rgba(accent, 0.28, spaced=False),
        "--bitfun-color-surface-subtle": rgba(surface, 0.50, spaced=False),
        "--bitfun-color-action-quiet-hover": rgba(surface, 0.58, spaced=False),
        "--bitfun-color-action-neutral-surface": rgba(elevated, 0.66, spaced=False),
        "--bitfun-color-action-neutral-surface-hover": rgba(elevated, 0.70, spaced=False),
        "--bitfun-color-action-neutral-surface-pressed": rgba(elevated, 0.78, spaced=False),
    }
    return {
        "theme-tokens": {
            "version": 1,
