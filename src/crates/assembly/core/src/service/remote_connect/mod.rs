...
pub mod relay_failure {
    pub use bitfun_services_integrations::remote_connect::relay_failure::*;
}
...
pub mod host_stream {
    pub use bitfun_services_integrations::remote_connect::host_stream::*;
}

pub mod host_stream_subscriber {
    pub use bitfun_services_integrations::remote_connect::host_stream_subscriber::*;
}
