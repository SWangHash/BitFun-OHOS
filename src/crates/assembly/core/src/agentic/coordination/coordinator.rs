            ...
            if let Err(error) = event_queue
                .enqueue(
                    AgenticEvent::DialogTurnCompleted {
                        ...
                        first_result_ms: execution_result.first_result_ms,
                        modified_file_count: execution_result.modified_file_count,
                        added_lines: execution_result.added_lines,
                        deleted_lines: execution_result.deleted_lines,
                    },
                    None,
                )
                .await
