...
//!
//! Core keeps the best-effort filesystem hook and sidecar persistence. The
//! deterministic report rewrite is owned by `bitfun-agent-runtime` so it can
//! be tested without core session or storage dependencies.
