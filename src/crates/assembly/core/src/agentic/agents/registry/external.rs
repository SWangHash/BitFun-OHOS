...
/// These and the hidden BitFun control Agent resolve through the primary path for create, turn,
...
fn is_builtin_session_primary_agent(id: &str) -> bool {
    matches!(
        id,
        CODE_REVIEW_AGENT_TYPE | DEEP_REVIEW_AGENT_TYPE | REVIEW_FIXER_AGENT_TYPE | "BitFun"
    )
}
