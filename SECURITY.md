...
BitFun starts a new stable product line at `1.0.0` and ships as a rolling release. Security fixes land on the latest release; older versions are not patched separately.
...
- Issues in third-party dependencies (please report those upstream; let us know if an BitFun update is needed).
