  ...
  if (kind === "ambient") {
    return (
      <div className="flow-chat-tool-card-preview" data-preview-kind="ambient">
        <AmbientToolCard
          data-bitfun-preview-state={previewState}
          ...
          <ProminentToolCardSummary
            ...
            content={(
              <code className="flow-chat-tool-card-preview__command">
                {'curl -s -o /dev/null -w "HTTP %{http_code}" https://bitfun.com'}
              </code>
            )}
            extra={(
              <ToolCardChangeSummary
  ...
  return (
    <div className="flow-chat-tool-card-preview">
      <ReadFileToolCard
        ...
        action={action}
        content={content}
        data-bitfun-preview-state={state === "hover" ? "hover" : undefined}
        ...
        results={kind === "grep" ? undefined : [
          {
            ...
            url: kind === "web" ? "https://bitfun.com/docs/flow-chat" : undefined,
          },
          {
  ...
  if (kind === "run-code") {
    ...
    card = (
      <WebFetchToolCard
        ...
        url="https://bitfun.com/docs/flow-chat"
      />
    );
