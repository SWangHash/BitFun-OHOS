...
export function tokenNameToCssVariable(name, prefix = "bitfun") {
...
export function createTokenArtifacts(tokens, options = {}) {
  const { exportName = "tokens", prefix = "bitfun" } = options;
  ...
  return {
    ...
    typescript: [
      ...
      "export declare const cssVariables: Readonly<Record<TokenName, `--bitfun-${string}`>>;",
      "",
    ].join("\n"),
    values,
  };
