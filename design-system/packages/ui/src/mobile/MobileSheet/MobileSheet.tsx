...
export const MobileSheet = forwardRef<HTMLDivElement, MobileSheetProps>(
  function MobileSheet({
    ...
    const titleId = `bitfun-mobile-sheet-title-${useId()}`;
    const descriptionId = `bitfun-mobile-sheet-description-${useId()}`;
    ...
    return (
      <Portal target={portalTarget}>
        <div
          ...
          data-bitfun-component="mobile-sheet"
        ...
        >
          <div
            ...
            tabIndex={-1}
          >
            {showHandle && <div aria-hidden="true" className={styles.handle} data-bitfun-part="handle" />}
            <header className={styles.header} data-bitfun-part="header">
              <div className={styles.heading} data-bitfun-part="heading">
              ...
              {headerAction !== undefined && headerAction !== null && (
                <div className={styles.headerAction} data-bitfun-part="header-action">{headerAction}</div>
              )}
            </header>
            <div className={styles.body} data-bitfun-part="body">{children}</div>
            {footer !== undefined && footer !== null && (
              <footer className={styles.footer} data-bitfun-part="footer">{footer}</footer>
            )}
          </div>
        </div>
      </Portal>
