...
export const Toolbar = forwardRef<HTMLDivElement, ToolbarProps>(function Toolbar({
  ...
  return (
    ...
    >
      ...
      {hasCenter && (
        <div className={styles.center} data-bitfun-part="center">{center}</div>
      )}
...
export const ToolbarBadge = forwardRef<HTMLSpanElement, ToolbarBadgeProps>(
  function ToolbarBadge({ children, className, ...props }, ref) {
    return (
      <NumberBadge {...props} className={classNames(styles.badge, className)} data-bitfun-part="badge" ref={ref} value={children} />
    );
  },
);
