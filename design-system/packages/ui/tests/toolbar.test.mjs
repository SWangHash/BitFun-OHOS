...
test("Toolbar keeps leading, centered, and trailing regions independent", () => {
  ...
  assert.match(markup, /data-bitfun-component="toolbar"/);
  assert.match(markup, /data-has-center="true"/);
  assert.match(markup, /data-bitfun-part="leading"/);
  assert.match(markup, /data-bitfun-part="center"/);
  assert.match(markup, /data-bitfun-part="trailing"/);
  assert.match(markup, /data-bitfun-part="badge"/);
  assert.match(markup, /data-bitfun-part="value">18<\/span>/);
  assert.match(markup, /data-bitfun-part="separator"/);
...
test("Toolbar styles bind geometry and overflow treatment to public tokens", async () => {
  ...
  assert.match(styles, /--bitfun-layout-toolbar-sm-height/);
  assert.match(styles, /--bitfun-layout-toolbar-md-height/);
  assert.match(styles, /--bitfun-layout-toolbar-content-gap/);
  assert.match(styles, /--bitfun-layout-toolbar-badge-size/);
  assert.match(styles, /--bitfun-layout-toolbar-overflow-fade-extent/);
