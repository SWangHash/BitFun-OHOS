...
test("Card keeps media, header, body, and footer regions independent", () => {
  ...
  assert.match(markup, /data-bitfun-component="card"/);
  ...
  assert.match(markup, /data-bitfun-part="header-content"/);
  assert.match(markup, /data-bitfun-part="leading"/);
  assert.match(markup, /data-bitfun-part="title">Projects/);
  assert.match(markup, /data-bitfun-part="description">One item/);
  assert.match(markup, /data-bitfun-part="actions"/);
  assert.match(markup, /data-bitfun-part="body"/);
  assert.match(markup, /data-align="end"[^>]+data-bitfun-part="body"/);
...
test("Card styles use public surface, spacing, radius, and elevation tokens", async () => {
  ...
  assert.match(styles, /--bitfun-shadow-overlay/);
  assert.match(styles, /--bitfun-layout-card-padding-sm/);
  assert.match(styles, /--bitfun-layout-card-radius-lg/);
  assert.match(styles, /data-radius=none[^}]*border-radius:0/);
  assert.match(styles, /--bitfun-layout-card-media-min-block-size/);
