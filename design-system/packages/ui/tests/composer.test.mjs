...
test("Composer exposes independent context, editor, and toolbar regions", () => {
  ...
  assert.match(markup, /data-bitfun-component="composer"/);
  assert.match(markup, /<fieldset/);
  assert.match(markup, /data-has-context="true"/);
  assert.match(markup, /data-bitfun-part="context"/);
  assert.match(markup, /data-bitfun-part="context-bar"/);
  assert.match(markup, /data-bitfun-part="surface"/);
  assert.match(markup, /data-bitfun-part="editor"/);
  assert.match(markup, /data-bitfun-part="toolbar"/);
  assert.match(markup, /data-bitfun-part="toolbar-bar"/);
...
test("Composer styling uses only shared public token layers", async () => {
  ...
  assert.match(styles, /--bitfun-control-composer-context-offset/);
  assert.match(styles, /--bitfun-control-composer-min-block-size/);
  ...
  assert.doesNotMatch(styles, /\.surface:focus-within\s*\{[^}]*--bitfun-color-focus-ring/s);
