...
const css = [
  renderCss(semanticThemes.light, {
    layer: "bitfun.tokens.theme",
    selector: ':where([data-bitfun-design-system-root]), :where([data-bitfun-design-system-root][data-color-scheme="light"])',
  }),
  renderCss(semanticThemes.dark, {
    layer: "bitfun.tokens.theme",
    selector: ':where([data-bitfun-design-system-root][data-color-scheme="dark"])',
  }),
  renderCss(diffResolvedTokens(semanticThemes.light, semanticThemes.highContrastLight), {
    layer: "bitfun.tokens.theme",
    selector: ':where([data-bitfun-design-system-root][data-color-scheme="light"][data-contrast="high"])',
  }),
  renderCss(diffResolvedTokens(semanticThemes.dark, semanticThemes.highContrastDark), {
    layer: "bitfun.tokens.theme",
    selector: ':where([data-bitfun-design-system-root][data-color-scheme="dark"][data-contrast="high"])',
  }),
].join("\n");
...
const declarationSource = [
  ...
  "export declare const themeCssVariables: Readonly<Record<ThemeTokenName, `--bitfun-${string}`>>;",
