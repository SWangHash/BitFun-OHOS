...
const css = [
  renderCss(semanticThemes.light, {
    ...
    selector: ':where([data-bf-design-system-root]), :where([data-bf-design-system-root][data-color-scheme="light"])',
  }),
  renderCss(semanticThemes.dark, {
    layer: "bf.tokens.theme",
    selector: ':where([data-bf-design-system-root][data-color-scheme="dark"])',
  }),
  renderCss(diffResolvedTokens(semanticThemes.light, semanticThemes.highContrastLight), {
    layer: "bf.tokens.theme",
    selector: ':where([data-bf-design-system-root][data-color-scheme="light"][data-contrast="high"])',
  }),
  renderCss(diffResolvedTokens(semanticThemes.dark, semanticThemes.highContrastDark), {
    layer: "bf.tokens.theme",
    selector: ':where([data-bf-design-system-root][data-color-scheme="dark"][data-contrast="high"])',
  }),
].join("\n");
...
const declarationSource = [
  ...
  "export declare const themeCssVariables: Readonly<Record<ThemeTokenName, `--bf-${string}`>>;",
