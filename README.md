...
![BitFun](./png/bitfun-wordmark.png)

[![Trendshift](https://trendshift.io/api/badge/repositories/44672)](https://trendshift.io/repositories/44672)

### Built to keep going.

BitFun is an open-source desktop workspace for AI agents. It brings together a fast, reliable **Rust Agent Runtime**, a powerful, flexible **Agent Harness**, and a polished **desktop experience** to make working with agents straightforward.
...
**⭐ Star BitFun to follow its progress and help others discover the project.**

[Download](https://bitfun.com/download) · [Mini App Marketplace](https://market.bitfun.com/miniapp/) · [Contribute](./CONTRIBUTING.md)

[![Website](https://img.shields.io/badge/Website-bitfun.com-0b7285?style=flat-square)](https://bitfun.com/)
[![Core code: MIT](https://img.shields.io/badge/core_code-MIT-yellow?style=flat-square)](./LICENSE)
[![Platform](https://img.shields.io/badge/platform-Windows%20%7C%20macOS%20%7C%20Linux-blue?style=flat-square)](https://bitfun.com/download)

</div>

![The BitFun desktop interface](./png/bitfun-desktop.png)
...
![Four working modes: Minimal, Standard, Ultimate, and Creative](./png/bitfun-harness-modes.png)
...
![BitFun across a laptop, phone, watch, and glasses](./png/bitfun-multi-device.png)
...
Install and reuse the apps you build, or explore the [Mini App Marketplace](https://market.bitfun.com/miniapp/) for tools that fit your work.

## Extend BitFun with BitFun
...
- **Change the interface and source.** Install [skins](https://market.bitfun.com/skin/) for a new look, or modify the UI, tools, and runtime source to build your own version of BitFun.

**You can ask BitFun's Code Agent to modify and extend BitFun itself.**
...
In this **DeepSWE v1.1** evaluation, BitFun achieved:
...
![DeepSWE v1.1 comparison: pass rate, runtime P50, and token P50](./png/bitfun-deepswe-v1.1.png)

## More to explore

**These are just some of BitFun's features.** Explore more tools, workflows, and extensions as you put it to work on your own tasks.

![A selection of BitFun's features](./png/bitfun-feature-wall.jpg)

## Where we're headed

BitFun is still evolving. Here are three directions we want to explore:
...
Data migration is optional and uses a **separately downloaded BitFun Data
...
**Star BitFun to follow along. Share what you build, offer feedback, or contribute code to help shape what comes next.**
...
Get the Windows, macOS, or Linux package from the [official download page](https://bitfun.com/download). Install it, configure a model, and open a workspace to get started. See the [user guide](https://playbook.bitfun.com) for usage instructions and [download verification](./docs/verify-downloads.md) for package signature checks.
