...
```bash
VERSION=v1.0.0
ASSET=bitfun-cli-1.0.0-aarch64-unknown-linux-gnu.tar.gz
...
```powershell
$Version = "v1.0.0"
$Asset = "BitFun_1.0.0_windows-x86_64-setup.exe"
$Base = "https://github.com/GCWing/BitFun/releases/download/$Version"
...
This is not platform code signing. In particular, an BitFun `.sig` is not an
