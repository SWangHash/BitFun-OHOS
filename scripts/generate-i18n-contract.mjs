...
const outputs = [
  {
    path: path.join(root, 'src/apps/mobile/android/app/src/main/kotlin/com/bitfun/mobile/app/platform/GeneratedLocaleContract.kt'),
    generate: (contract) => `// Generated by scripts/generate-i18n-contract.mjs. Do not edit.
package com.bitfun.mobile.app.platform

internal const val DEFAULT_APP_LANGUAGE_TAG = "${contract.surfaceDefaults.android}"
`,
  },
  {
