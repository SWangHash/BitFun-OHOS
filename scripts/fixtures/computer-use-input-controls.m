...
int main(int argc, const char **argv) { @autoreleasepool {
    ...
    if (strcmp(argv[1], "--observer") == 0) {
        ...
        NSWindow *window = [[NSWindow alloc] initWithContentRect:(getenv("BITFUN_INPUT_COVER_TARGET") && strcmp(getenv("BITFUN_INPUT_COVER_TARGET"),"1")==0 ? NSMakeRect(80,80,760,340) : NSMakeRect(850,100,240,180)) styleMask:NSWindowStyleMaskTitled backing:NSBackingStoreBuffered defer:NO];
        window.title = @"BitFun Foreground Observer";
    ...
    targetWindow.title = @"BitFun Inactive Controls Fixture";
