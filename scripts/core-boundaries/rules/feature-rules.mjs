  ...
  },
  {
    ...
    dependencies: [
      ...
      { depName: 'bitfun-runtime-ports', ownerFeatures: ['deep-research', 'git', 'remote-connect', 'remote-ssh', 'remote-ssh-concrete', 'script-tool-runtime'] },
      {
        ...
        ownerFeatures: ['account-identity', 'browser-control', 'git', 'hook-import', 'mcp', 'miniapp-runtime', 'process-tree', 'remote-connect', 'remote-persistence', 'remote-ssh', 'review-platform', 'system-vault', 'workspace-search'],
      },
      { depName: 'bzip2', ownerFeatures: ['speech'] },
      { depName: 'chrono', ownerFeatures: ['account-identity', 'anonymous-auth', 'debug-log', 'feedback', 'git', 'miniapp-market', 'privacy', 'remote-connect', 'remote-ssh-concrete', 'review-platform', 'speech'] },
      ...
      { depName: 'fs2', ownerFeatures: ['plugin-source', 'remote-connect', 'remote-persistence'] },
      ...
      { depName: 'hostname', ownerFeatures: ['remote-connect', 'remote-persistence'] },
      ...
      { depName: 'sha2', ownerFeatures: ['canvas-runtime', 'feedback', 'hook-import', 'mcp', 'miniapp-market', 'models-dev', 'plugin-source', 'privacy', 'remote-connect', 'remote-persistence', 'remote-ssh', 'review-platform', 'speech'] },
      ...
      { depName: 'thiserror', ownerFeatures: ['browser-control', 'git', 'hook-import', 'miniapp-market', 'plugin-source', 'remote-connect', 'remote-ssh', 'remote-ssh-concrete', 'review-platform', 'speech', 'web-tools', 'workspace-search', 'account-identity'] },
      ...
      { depName: 'windows', ownerFeatures: ['models-dev', 'plugin-source', 'remote-connect', 'remote-persistence', 'review-platform'] },
...
export const coreClosedFeatureProfileRules = [
  ...
  },
  {
    ...
    requiredFeatureRefs: [
      ...
      'bitfun-services-core/workspace-transfer',
    ],
    allowedTransitiveFeatureRefs: [
      'ai-adapter-runtime',
      'filesystem',
