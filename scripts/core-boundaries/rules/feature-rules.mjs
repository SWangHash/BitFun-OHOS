...
export const optionalDependencyFeatureOwnerRules = [
  ...
  },
  {
    ...
    dependencies: [
      ...
      {
        depName: 'async-trait',
        ownerFeatures: ['feedback', 'git', 'mcp', 'miniapp-market', 'remote-connect', 'remote-ssh', 'remote-ssh-concrete', 'review-platform', 'script-tool-runtime', 'speech', 'workspace-search'],
      },
      {
        depName: 'base64',
      ...
      { depName: 'chrono', ownerFeatures: ['debug-log', 'feedback', 'git', 'remote-connect', 'remote-ssh-concrete', 'review-platform', 'speech'] },
      ...
      { depName: 'sha2', ownerFeatures: ['canvas-runtime', 'feedback', 'hook-import', 'mcp', 'miniapp-market', 'models-dev', 'plugin-source', 'remote-connect', 'remote-ssh', 'review-platform', 'speech'] },
