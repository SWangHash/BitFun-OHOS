...
export const optionalDependencyFeatureOwnerRules = [
  ...
  },
  {
    ...
    dependencies: [
      ...
      { depName: 'sha2', ownerFeatures: ['canvas-runtime', 'feedback', 'hook-import', 'mcp', 'miniapp-market', 'models-dev', 'plugin-source', 'privacy', 'remote-connect', 'remote-ssh', 'review-platform', 'speech'] },
