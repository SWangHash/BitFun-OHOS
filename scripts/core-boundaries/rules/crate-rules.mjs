...
const agentRuntimeIpcForbiddenDeps = [
  ...
  'openbitfun-dsh-adapter',
  'openbitfun-external-sources',
  'openbitfun-opencode-adapter',
  'openbitfun-page-function-runtime',
  ...
  'openbitfun-tool-call-jsonrepair',
  'openbitfun-tool-packs',
  'openbitfun-webdriver',
  'terminal-core',
  'tool-runtime',
  'tauri',
  'reqwest',
