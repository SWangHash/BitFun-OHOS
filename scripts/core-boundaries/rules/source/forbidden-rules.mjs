    ...
    patterns: [
      {
        ...
        message:
          'core agent mode module must not own Standard Harness prompt facts; use bitfun-agent-runtime agents',
      },
      {
        regex: /\bpub const STANDARD_HARNESS_CONFIG_ID\b/,
        message:
          'core agent mode module must not own Standard Harness config profile facts; use bitfun-agent-runtime agents',
      },
      {
        regex: /\bpub const STANDARD_HARNESS_CONFIG_MEMBERS\b/,
        message:
          'core agent mode module must not own Standard Harness membership facts; use bitfun-agent-runtime agents',
      },
      {
      ...
      },
      {
        ...
        message:
          'core agent mode module must not own Standard Harness context policy; use bitfun-agent-runtime agents',
      },
    ],
  },
  {
    ...
    patterns: [
      {
        ...
        message:
          'core review_read_receipt must not own file revision DTOs; use bitfun-agent-runtime review_read_receipt',
      },
      {
        regex: /\bpub struct ReviewReadCoverage\b/,
        message:
          'core review_read_receipt must not own review coverage DTOs; use bitfun-agent-runtime review_read_receipt',
      },
      {
        regex: /\bpub struct ReviewReadReceiptStore\b/,
        message:
          'core review_read_receipt must not own the receipt store; use bitfun-agent-runtime review_read_receipt',
      },
      {
        regex: /\bDashMap\b/,
        message:
          'core review_read_receipt must not own receipt storage maps; use bitfun-agent-runtime review_read_receipt',
      },
    ],
  },
  {
